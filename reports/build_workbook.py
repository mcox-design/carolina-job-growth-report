...
WINDOW = "2026-01-27 to 2026-07-27"  # trailing 6 months

PRIOR_REPORT_DATE = "2026-07-13"
PRIOR_WINDOW = "2026-01-13 to 2026-07-13"
...
# ---- Week 4 (2026-07-27) ----
WEEK4_RUNNING = [
    ["2026-07-27", "Repeated", 1, 93, "Charlotte / Uptown", "Mecklenburg", "NC",
     "SMBC Group — 2nd US HQ / bank operations", "Banking / financial services",
     "Lease signed / active hiring milestone", 2000, "Projected (6 yr)",
     "$165,316 avg (stated; vs county $90,706)", "N/A — stated", "$50.5M",
     "JDIG up to $70.0M / 12 yr; $23.3M IDF-Utility Account", "Leased former One Wells Fargo Center; hiring 70+ roles; first workers fall 2026",
     ...
     "High", "Office / HQ banking", "Urban",
     "Premier high-income signal; Class-A urban MF + high-end for-sale TH in Uptown/South End/Dilworth.",
     "No new in-window milestone found this cycle; project remains on track for fall 2026 first-worker arrivals."],

    ["2026-07-27", "Updated", 2, 90, "Rock Hill / York Co.", "York", "SC",
     "Octapharma — \"Project Palmetto Rock\" HQ + manufacturing campus (fully approved)", "Biopharmaceutical (plasma fractionation)",
     "Final city + county approval (rezoning, land sale, tax-incentive resolution)", 1500, "Projected (1,200 new + 300 relocated)",
     "$141,502 avg HQ / $102,752 avg mfg (both stated)", "N/A — stated", "$1.5B",
     "Fee-in-lieu-of-tax; Rock Hill forgoes ~85% of its project tax share; York County contributes 10% of its EDA fund revenue; ~$80M directed to Rock Hill Schools over 40 yrs",
     "Rock Hill City Council approved 7-0 (rezoning, land sale, tax-incentive resolution) on 2026-07-23, following York County Council's 4-3 third-reading approval on 2026-07-08/09; construction could start late 2026, buildout ~10 yrs",
     ...
     "High (facts); High (deal certainty — now fully approved)", "Office/HQ + biopharma mfg", "Suburban",
     "Dual-tier: $141k HQ roles -> luxury for-sale/Class-A in Rock Hill/Fort Mill; $102k mfg roles -> premium workforce-plus rental/TH. Approval removes the deal's last major execution risk.",
     "Rock Hill City Council's unanimous vote resolves the outstanding-vote risk flagged in the 2026-07-13 report; deal now fully approved at both city and county level. +3 vs prior cycle."],

    ["2026-07-27", "Gaining Momentum", 3, 86, "Blythewood / N. Columbia", "Richland", "SC",
     "Scout Motors — EV assembly plant (training center opens; first body weld)", "Automotive / EV manufacturing",
     "Training-center opening + production-validation milestone", 4000, "Projected (600+ SC production hires)",
     "$30-$37.50/hr line (stated, news); salaried higher", "Estimated/Inferred mix supports above-median HH income",
     "$2.0B (+$25M training center)", "State/local package (2023); $25M readySC", "Training Center opened 2026-04-20; first vehicle body weld completed June 2026 (validation build); customer deliveries trending toward 2028",
     "2026-04-20", "https://www.wistv.com/2026/04/20/scout-motors-hold-grand-opening-blythewood-area-training-center/",
     "High", "Auto mfg + salaried eng.", "Suburban",
     "Bifurcated: salaried/professional -> higher-income for-sale & Class-A; hourly base -> workforce/missing-middle rental in N. Richland/Fairfield.",
     "600+ hired at the SC production site as of April 2026 (~1,313 companywide per Revelio Labs, Dec 2025). Correction: the '70+ maintenance-tech interview event beginning 7/29' cited in the 2026-07-13 report is a July 2025 event, not 2026 — no 2026 repeat found. Feb 2026 reporting suggests customer deliveries may slip to summer 2028; company reaffirms 2027 initial production."],

    ["2026-07-27", "Repeated", 4, 84, "Durham / RTP", "Durham", "NC",
     "AbbVie — biopharma manufacturing campus", "Biopharma / life sciences mfg",
     "New facility (greenfield, 185 ac)", 734, "Projected (+2,000 construction)",
     "$118,041 avg (stated; vs county $102,817)", "N/A — stated", "$1.4B",
     "JDIG up to $19.3M / 12 yr; $6.4M IDF-Utility; +city/county", "Construction 2026; complete ~end-2028; hiring through ~2031",
    ...
    ["2026-07-27", "Repeated", 5, 81, "Charlotte", "Mecklenburg", "NC",
     "Capital Group — East Coast ops hub", "Investment mgmt / finance + tech",
     "Lease commenced", 600, "Projected",
     "$194,141 avg (stated)", "N/A — stated", "$60M",
     "JDIG up to $17.2M / 12 yr; $5.7M IDF-Utility", "16-yr lease at One Independence Center (196,940 sq ft) commenced 2026-05-22; hiring 2027-2031",
     "2026-05-22", "https://businessnc.com/capital-group-picks-its-uptown-charlotte-spot-for-600-workers",
     "High", "Office — finance/tech", "Urban-suburban",
     "High-skill eng/data workforce -> walkable South End/Uptown & inner-suburban Class-A and for-sale TH.",
     "No new in-window milestone beyond the already-confirmed lease-commencement date; unchanged since 2026-07-13."],

    ["2026-07-27", "Repeated", 6, 80, "Holly Springs / SW Wake", "Wake", "NC",
     "Genentech — biomanufacturing expansion", "Adv. biomanufacturing",
     "Expansion of committed project", 500, "Projected (site total)",
     "~$119,833 avg (stated, original 2025 tranche)", "N/A — stated", "~$2.0B (doubled from ~$700M)",
     "JDIG up to $9.85M / 12 yr (original 420-job award)", "Operational by 2029",
     "2026-01-20", "https://www.gene.com/media/press-releases/15096/2026-01-20/genentech-more-than-doubles-investment-i",
     "High", "Adv. biomanufacturing", "Suburban",
     "Strong higher-income for-sale + Class-A rental in fast-growing SW Wake (Holly Springs/Apex/Fuquay).",
     "No new in-window milestone found this cycle. Some 2026 coverage references a total nearer 600 site jobs; unverified as a distinct dated milestone — flagged for next cycle."],

    ["2026-07-27", "Updated", 7, 79, "Greensboro / PTI Airport", "Guilford", "NC",
     "JetZero — aerospace plant (EXIM financing exploration)", "Aerospace / advanced manufacturing",
     "Letter of Interest for federal financing", 14500, "Projected",
     "$89,340 avg (stated, 2025)", "N/A — stated (2025)", "$4.7B",
     "JDIG up to ~$1.02B / 37 yr; Guilford grant ~$75.9M / 20 yr; EXIM exploring up to $3B financing (non-binding)",
     "EXIM Letter of Interest signed 2026-07-20 at the Farnborough Airshow to explore up to $3B in financing under EXIM's 'Make More in America' initiative; explicitly not a financing commitment, subject to due diligence and EXIM Board approval",
     "2026-07-20", "https://aviationweek.com/aerospace/manufacturing-supply-chain/jetzero-exim-explore-3b-financing-manufacturing-campus",
     "High (facts); Low (timeline)", "Aerospace mfg + eng.", "Suburban",
     "Same long-run scale as prior cycles; the financing signal is a modest positive but does not resolve the hiring-ramp delay.",
     "Non-binding financing exploration only; does not change the JDIG-amendment hiring ramp (zero jobs projected for 2027, full 14,500-job target due by 2037). Score held flat."],

    ["2026-07-27", "Repeated", 8, 77, "Durham / Morrisville", "Durham & Wake", "NC",
     "Novartis — API mfg building", "Adv. mfg / API production",
     "Investment increase (prior cycle)", 700, "Projected (part of pre-window deal)",
     "$111,161 avg (stated)", "N/A — stated", "~$991M (incl. $220M)",
     "State/local incentive package (Wake/Durham)", "Facilities opening 2027-2028",
     "2026-04-30", "https://www.wral.com/news/local/novartis-pharmaceuticals-expands-nc-presence-morrisville-plant-april-2026/",
     "High", "Adv. mfg / API production", "Suburban",
     "Reinforces sustained high-wage biomanufacturing hiring in the Wake/Durham corridor.",
     "No new in-window milestone found this cycle."],

    ["2026-07-27", "New (promoted from Excluded)", 9, 74, "Charlotte / Ballantyne", "Mecklenburg", "NC",
     "Citigroup — Ballantyne regional office (grand opening + hiring ramp)", "Banking / financial services",
     "Office grand opening + active hiring ramp", 510, "Projected; ~400 hired to date",
     "$131,832 avg (stated)", "N/A — stated", "$16.1M",
     "Not disclosed in sources reviewed", "Grand opening 2026-03-17; ~400 of 510 planned roles filled as of ~April 2026 (incl. 275 relocated internally); 3-floor, 90,000 sq ft building",
     "2026-03-17", "https://hoodline.com/2026/03/stein-hits-ballantyne-as-citi-bets-big-on-charlotte-jobs",
     "High (facts); Med (promotion basis)", "Office — banking/financial services", "Suburban",
     "Strong suburban Class-A rental + move-up for-sale demand in Ballantyne/south Charlotte; $131,832 wage supports higher-income housing product.",
     "Promoted from Excluded to Ranked this cycle: the in-window grand opening plus a confirmed hiring-ramp to ~400/510 roles is genuine forward-moving execution, not merely a delayed pre-window commitment (same logic used for SMBC's Week-2 promotion). Prior cycles excluded this deal; this reverses that call."],
]

RUNNING = WEEK1_RUNNING + WEEK2_RUNNING + WEEK3_RUNNING + WEEK4_RUNNING
...
# ---- Week 4 (2026-07-27) — carried-forward items updated + new items ----
WEEK4_WATCH = [
    ["2026-07-27", "Cherokee Co. / Blacksburg", "Cherokee", "SC", "USA Rare Earth — rare-earth magnet plant", "~490", "$1.2B",
     "Not disclosed; $24.50-$63/hr stated range", "Still just under 500 jobs; facility now targeted to open April 2028 (later ramp than previously implied)", "2026-06-02",
     "https://investors.usare.com/news-releases/news-release-details/usa-rare-earth-selects-cherokee-county-south-carolina-new-rare", "High"],
    ["2026-07-27", "Laurens Co.", "Laurens", "SC", "Suniva — solar-cell plant", "564", "$350M",
     "Stated $23-$53/hr = workforce-tier", "No update found; operations still targeted spring/summer 2027", "2026-04-14",
     "https://governor.sc.gov/news/2026-04/suniva-inc-selects-laurens-county-first-south-carolina-manufacturing-facility", "High"],
    ["2026-07-27", "Gray Court / Laurens Co.", "Laurens", "SC", "Aptiv Services US — Connexial Center", "277", "$120.8M",
     "Not disclosed", "No update found this cycle", "2026",
     "https://www.golaurens.com/news/laurens-county-welcomes-277-jobs-and-120-million-from-aptiv/article_a0c4713d-b677-40d3-b3a7-c68779533f7c.html", "High"],
    ["2026-07-27", "Columbia / BullStreet", "Richland", "SC", "AMAROK — new HQ (perimeter security)", "296", "$69M",
     "Not disclosed; Estimated/Inferred sub-$100k (security-tech corporate/sales mix)", "Formal announcement confirmed 2026-03-24; 125,000 sq ft building, houses 500+ total employees incl. relocated staff, online by end of 2028", "2026-03-24",
     "https://governor.sc.gov/news/2026-03/amarok-expands-richland-county-operations-new-headquarters", "High"],
    ["2026-07-27", "Greensboro", "Guilford", "NC", "Lumentum — AI/data-center optics", "~400", "Hundreds of millions",
     "Not disclosed", "Confirmed announcement date 2026-03-26 (240,000 sq ft indium-phosphide laser plant on former Qorvo site); production targeted mid-2028; no update since", "2026-03-26",
     "https://www.areadevelopment.com/newsitems/4-14-2026/lumentum-greensboro-north-carolina.shtml", "Med"],
    ["2026-07-27", "Hendersonville", "Henderson", "NC", "BorgWarner — vertical-integration expansion", "378", "$100M",
     "$67,047 avg (stated; below $100k)", "No update found this cycle", "2026-05-26",
     "https://www.commerce.nc.gov/news/press-releases/2026/05/26/governor-stein-announces-100-million-expansion-borgwarner-hendersonville", "High"],
    ["2026-07-27", "Asheville / Arden", "Buncombe", "NC", "Eaton — Low Voltage Assembly expansion", "300", "Not disclosed",
     "Mixed band: current postings range $19.50/hr (Assembler) to $86k-$126k (LVA Mfg Supervisor)", "No update found this cycle beyond confirmed wage-band detail", "2026-04-07",
     "https://www.ashevillechamber.org/news-events/press-releases/eaton-invests-in-workforce-growth-in-buncombe-county/", "High (jobs); Low (wage)"],
    ["2026-07-27", "Charlotte / Raleigh / Rural Hall", "Multi", "NC", "Siemens Energy — $421M NC expansion", "500 (statewide)", "$421M",
     "Not disclosed; Charlotte/Mecklenburg-specific split still unconfirmed", "No update found; county-level job split still not disclosed despite renewed search", "2026-02-05",
     "https://businessnc.com/siemens-energys-421-million-n-c-expansion-adding-500-jobs/", "High (totals); Low (wage/split)"],
    ["2026-07-27", "Knightdale / Wendell", "Wake", "NC", "Siemens AG — power devices for AI/data centers", "350", "part of $165M",
     "Not disclosed", "New Wendell facility (101,000 sq ft, ~50 jobs) came online July 2026 as expected; Knightdale (131,000 sq ft, ~100 jobs) still targeting end of 2026", "2026-07",
     "https://www.wral.com/business/siemens-350-jobs-nc-sc-165m-investment-ai-data-centers-raleigh-wendell-march-2026/", "High"],
    ["2026-07-27", "Kernersville", "Forsyth", "NC", "John Deere — excavator plant (relocating from Japan)", "150+", "$70M",
     "Not disclosed (Inferred skilled-mfg)", "Project reaffirmed via a White House social-media assist ~Jan 2026; construction underway on west campus; no further update this cycle", "2026-01",
     "https://hpj.com/2026/01/28/deere-announces-two-new-u-s-plants", "Med"],
    ["2026-07-27", "York Co.", "York", "SC", "QTS \"Project Cobra\" — data-center campus", "~200 FTE (+~1,000 constr.)", "up to $8B",
     "~$80k median (stated)", "York County's 9-month data-center moratorium passed final reading 2026-07-13 but does not affect QTS's already-permitted (2023) construction", "2026-07-13",
     "https://www.wbtv.com/2026/06/17/york-county-weighs-9-month-moratorium-new-data-centers-what-we-know/", "High (facts)"],
    ["2026-07-27", "Berkeley / Dorchester", "Berkeley & Dorchester", "SC", "Google — data-center expansion", "~160 apprentices (FTE n/d)", "$9B",
     "Not disclosed", "$9B investment now confirmed to cover the existing Berkeley County campus expansion plus two NEW Dorchester County campuses; no discrete permanent-job figure disclosed", "2026",
     "https://www.charlestondigital.com/news/google-announces-new-usd9b-investment-in-south-carolina-through-2027", "High (capex)"],
    ["2026-07-27", "Liberty", "Pickens", "SC", "FN America — 2nd production facility", "~176", "$33M",
     "Not disclosed", "Third consecutive quiet cycle with no movement — recommend removal next cycle absent an update", "2023",
     "https://www.sccommerce.com/news/fn-america-llc-expanding-south-carolina-footprint-pickens-county-second-production-facility", "High"],
    ["2026-07-27", "Spartanburg", "Spartanburg", "SC", "Siemens Smart Infrastructure", "~150", "$165M",
     "Not disclosed", "No update found this cycle", "2026-03-18",
     "https://www.foxcarolina.com/2026/03/18/tech-manufacturer-building-expanding-upstate-facilities-creating-150-new-jobs/", "Med-High"],
    ["2026-07-27", "Hamlet", "Richmond", "NC", "AWS/Amazon — AI/cloud campus", "500", "$10B",
     "Not disclosed", "Still unverified; Richmond County falls outside all five assigned research sub-regions this dataset tracks — carried forward unchanged pending a dedicated check", "verify",
     "https://www.aboutamazon.com/", "Low (needs verification)"],
    ["2026-07-27", "Wake Co. (aggregate)", "Wake", "NC", "County jobs pipeline (EDGE 7)", "~11,000 (pipeline); 60,000+ direct+indirect target", "$11B (pipeline); $3B (EDGE 7 target)",
     "Mixed (office-skewed)", "Raleigh Chamber formally launched EDGE 7, a 5-year strategy succeeding the closed EDGE 6 campaign (37 projects/$5.6B/10,800 jobs); no new named mega-project beyond items already tracked", "2026",
     "https://raleigh-wake.org/about-us/edge7", "Med"],
    ["2026-07-27", "Charlotte / SouthPark", "Mecklenburg", "NC", "JPMorgan Chase — new office", "400 new (1,000 total on-site)", "Not disclosed",
     "Estimated/Inferred ~$105k (unconfirmed)", "New office at One Piedmont Town Center (5 floors, 145,000 sq ft) confirmed 2026-04-21; consolidates 600+ existing staff plus 400 new; move-in early 2028", "2026-04-21",
     "https://www.axios.com/local/charlotte/2026/04/21/jpmorganchase-charlotte-hiring-workforce-banking-competition", "High"],
    ["2026-07-27", "Charlotte (CLT airport)", "Mecklenburg", "NC", "Averitt — logistics campus", "211", "$200M",
     "$81,769 (stated)", "No update found this cycle; confirmed unchanged", "2026-04-29",
     "https://www.axios.com/local/charlotte/2026/04/29/averitt-charlotte-douglas-airport-campus-jobs", "High"],
    ["2026-07-27", "Rowan County", "Rowan", "NC", "\"Project Rack\" (company undisclosed)", "258", "$41M",
     "Estimated/Inferred sub-$100k", "Rowan County Commissioners approved 3-year tax incentives 2026-06-05 for the still-undisclosed 'iconic American brand'; Q1 2027 operations start still targeted", "2026-06-05",
     "https://www.salisburypost.com/2026/06/05/rowan-county-approves-project-rack-incentives-for-258-job-distribution-site/", "High"],
    ["2026-07-27", "Rowan/Kannapolis", "Rowan", "NC", "Google (via DHL) — 730k sq ft warehouse lease", "Not disclosed", "Not disclosed",
     "$55k-$150k range (DHL postings)", "No update found; DHL actively hiring on-site but Kannapolis officials confirm no job total tied to the Google lease has been released", "2026-05",
     "https://www.wcnc.com/article/news/local/google-facility-planned-in-kannapolis", "Med"],
    ["2026-07-27", "Raleigh / North Hills", "Wake", "NC", "Ralliant Corp. — global HQ launch", "~150 on-site now (180 by 2029)", "$2.1M",
     "$170,531-$189,479 (stated)", "HQ formally opened 2026-03-05; state expects up to 180 high-paying jobs by 2029", "2026-03-05",
     "https://www.businesswire.com/news/home/20260305697057/en/Ralliant-Opens-Global-Headquarters-in-Raleigh-North-Carolina", "High"],
    ["2026-07-27", "Siler City", "Chatham", "NC", "Wolfspeed — silicon-carbide fab (layoffs announced; long-term target reaffirmed)", "1,800 (proj., slower pace)", "$5.0B",
     "$77,753 (stated)", "Wolfspeed disclosed ~2026-06-09 it will lay off 73 Siler City employees (effective 2026-08-08) amid soft demand and cut FY2026 revenue guidance to $850M, but reaffirmed the full 1,800-job Siler City commitment at a slower pace", "2026-06-09",
     "https://www.carolinajournal.com/wolfspeed-layoffs-at-its-siler-city-materials-factory/", "High (facts); Low (timeline)"],
    ["2026-07-27", "Benson", "Johnston", "NC", "Vulcan Elements — magnet factory", "1,000 (proj.)", "$918.4M",
     "$81,932 (stated)", "No new in-window update found on hiring/construction progress this cycle", "2025-11-18",
     "https://www.wunc.org/economy/2025-11-18/vulcan-elements-worlds-largest-magnet-factory-outside-china-benson", "Med"],
    ["2026-07-27", "Wake County (statewide)", "Wake", "NC", "WakeMed / Atrium Health — proposed merger", "3,300 (statewide, 5 yr)", "$2.0B (Wake Co. portion)",
     "Not disclosed", "Wake Commissioners voted 2026-05-04 to delay the vote by 90 days, pushing a potential vote to ~2026-08-02 — just after this window closes; opposition continues to mount", "2026-05-04",
     "https://www.wral.com/news/local/wakemed-atrium-health-planned-deal-state-auditor-calls-for-delay-may-2026/", "High"],
    ["2026-07-27", "RTP", "Wake", "NC", "Apple — RTP campus extension", "3,000 originally proj.; ~600-990 added to date", "$552M-$1B+ (paused)",
     "$187k (stated, 2021 award)", "DATE CORRECTION: the 4-yr incentive-timeline extension was approved 2025-11-25 (not April 2026 as previously reported); no active construction restart found", "2025-11-25",
     "https://9to5mac.com/2025/11/25/apple-granted-rare-timeline-extension-north-carolina-campus/", "High"],
    ["2026-07-27", "Greensboro / PTI Airport", "Guilford", "NC", "Boom Supersonic — Overture assembly (AT RISK)", "≤500 currently; must hit 500 by 12/31/26", "~$50M (hangar)",
     "Not disclosed", "Risk continues escalating: hangar still largely idle per most recent coverage; no updated employee-count disclosure found; deadline now ~5 months out with no positive movement", "2026-03",
     "https://www.hoodline.com/2026/03/greensboro-s-50-million-supersonic-ghost-hangar-puts-state-on-the-clock", "Med (facts); Low (outlook)"],
    ["2026-07-27", "Multi-site NC incl. Wilmington", "New Hanover +", "NC", "Amazon-Corning — fiber-optics partnership", "1,000 (multi-site, unallocated)", "Multi-billion (undisclosed NC-specific)",
     "Avg >$65,000 (disclosed; sub-$100k)", "Deal confirmed 2026-06-08; per-site (Wilmington vs. Concord) allocation still not disclosed; distinct from the larger Corning-Meta $6B Hickory/Catawba deal", "2026-06-08",
     "https://www.wect.com/2026/06/08/amazons-data-center-push-fuels-1000-job-fiber-optic-agreement-with-corning/", "High (facts); Low (allocation)"],
    ["2026-07-27", "Arden", "Buncombe", "NC", "Pratt & Whitney (RTX) — casting foundry expansion", "325", "$285M",
     "$62,413 (stated)", "No update found this cycle; on track for equipment arrival end 2026, first parts mid-2027", "2026",
     "https://businessnc.com/pratt-whitney-announces-285-million-expansion-325-more-jobs-for-buncombe-county", "High"],
    ["2026-07-27", "Asheboro", "Randolph", "NC", "Environmental Air Systems", "300", "$20M",
     "$55,133 (stated)", "No update found despite targeted searches — third consecutive quiet cycle", "2025-11-25",
     "https://www.commerce.nc.gov/news/press-releases/2025/11/25/environmental-air-systems-expand-randolph-county-adding-300-jobs-and-20-million-investment", "High"],
    ["2026-07-27", "Wilmington", "New Hanover", "NC", "GE Hitachi / Global Nuclear Fuel — GNF4 fuel line", "Not disclosed", "Not itemized ($50M+ cited)",
     "Not disclosed", "No update found; ~27 open GE Nuclear roles in Wilmington as of Feb 2026, but no discrete headcount figure disclosed for the GNF4 line", "2025-10",
     "https://www.wilmingtonbiz.com/more_news/2025/10/09/global_nuclear_fuel_to_fabricate_new_nuclear_fuel_product_in_wilmington", "Med"],
    ["2026-07-27", "Liberty", "Randolph", "NC", "Toyota Battery Manufacturing NC (TBMNC) — EV/hybrid battery megaplant", "5,100 (proj. total); 3,000+ employed", "$13.9B",
     "$62,234 (stated; below $100k)", "No new headcount milestone found beyond the previously reported 3,000+ figure; company still targets a new production line roughly every 4 months through decade's end", "2026-02",
     "https://www.wfmynews2.com/article/news/local/major-milestone-over-3000-people-now-work-at-the-toyota-battery-plant/83-b192b700-91b7-42f4-837e-33d0c01ee96e", "High"],
    ["2026-07-27", "Woodruff (Spartanburg Co.)", "Spartanburg", "SC", "AIRSYS Cooling Technologies — global HQ", "215 (at full operation)", "$40-60M",
     "Not disclosed", "Global HQ campus (264,000 sq ft) officially opened 2026-05-13; corporate teams now on-site, but manufacturing operations (bulk of production hiring) remain delayed to Q1 2027", "2026-05-13",
     "https://www.postandcourier.com/spartanburg/business/airsys-data-center-water-woodruff-sc/article_86465e32-7d21-4bba-9a9b-3e6ea0e2d691.html", "High"],
    ["2026-07-27", "Easley (Anderson/Pickens border)", "Anderson", "SC", "Signature Foods USA", "202", "$11.5M",
     "Estimated/Inferred sub-$50k", "No headcount update found beyond the previously confirmed April 2026 online-operations milestone", "2026-04",
     "https://www.postandcourier.com/greenville/business/easley-anderson-county-signature-foods-investment/article_1d618a58-af96-435a-a05c-7cc6f9253a83.html", "High"],
    ["2026-07-27", "Greenville", "Greenville", "SC", "GNQ Insilico — AI/quantum techbio HQ", "Not disclosed", "$500M (valuation, not capex)",
     "Not disclosed", "No headcount figure published yet; new detail found — SCRA $50,000 relocation grant + city $1,500/job development grants imply a modest near-term headcount, but no number confirmed", "2026",
     "https://www.upstatescalliance.com/announcements/gnq-insilico-a-500m-biotech-innovator-moving-to-greenville/", "Low (headcount unconfirmed)"],
    ["2026-07-27", "Greenville", "Greenville", "SC", "GE Vernova — gas turbine mfg", "650 total planned; ~200 hired 2025, ~300 more by end 2026", "$160M (Greenville)",
     "Estimated/Inferred mixed, bulk likely sub-$100k", "No new hiring-ramp confirmation found this cycle beyond job-board listing activity", "2026",
     "https://scbiz.com/ge-vernova-to-invest-160m-create-650-jobs-with-greenville-expansion/", "Med"],
    ["2026-07-27", "North Charleston", "Charleston", "SC", "Boeing 787 — production-rate ramp", "1,000 (unchanged)", "$1.0B (existing)",
     "Estimated/Inferred mixed", "No Q2/Q3 2026 rate update found; rate confirmed 8/month as of Jan 2026, full 10/month target still described as 'over the next year'", "2026-01-27",
     "https://scdailygazette.com/2026/01/27/boeing-looks-to-build-on-momentum-at-sc-dreamliner-plant/", "Med"],
    ["2026-07-27", "North Charleston", "Charleston", "SC", "SC Ports Authority — Leatherman Terminal (OPERATIONS PAUSED, CONFIRMED)", "400 direct + ~1,200 indirect", "$1.2B (existing)",
     "Not disclosed", "CONFIRMED REVERSAL: pause of container operations takes effect 2026-08-01 (decision announced 2026-06-25); cargo consolidates into Wando Welch and North Charleston terminals; no reopening timeline given, contingent on demand recovery", "2026-06-25",
    ...
    ["2026-07-27", "Goose Creek", "Berkeley", "SC", "HII (Newport News Shipbuilding) — 1-yr+ operations", "~250 (estimate)", "Not disclosed",
     "Not disclosed", "One-year anniversary reconfirmed 2026-01-22 (first-unit delivery within 40 days of startup, 2025 targets exceeded); no updated headcount figure found this cycle", "2026-01-22",
     "https://www.hii.com/news/hii-marks-one-year-of-newport-news-shipbuilding-charleston-operations", "Med"],
    ["2026-07-27", "Spartanburg (former Kohler plant)", "Spartanburg", "SC", "NorthMark \"Project Moc-1\" — AI/HPC data center", "~150 FT at full operation", "$2.8B",
     "Not disclosed", "Contested public hearing held 2026-06-25; DES comment period on the air permit runs through 2026-07-31 (closes just after this window); permit now seeks 11 additional gas turbines, raising approved capacity from ~50MW to ~450MW; Spartanburg Co.'s new one-year data-center moratorium explicitly exempts this already-approved project", "2026-06-25",
     "https://www.postandcourier.com/spartanburg/news/spartanburg-county-council-data-center-public-hearing/article_746815ab-5f55-48b4-915e-e8c20482aae5.html", "Med"],
    ["2026-07-27", "Orangeburg / I-26", "Orangeburg", "SC", "Ferrara Candy — new mfg + corporate site", "1,000 (10 yr)", "$675M",
     "Not disclosed; Estimated/Inferred sub-$100k (confectionery production)", "Groundbreaking held 2026-05-19/20 (Gov. McMaster, Rep. Clyburn attended); first production lines targeted early 2029", "2026-05-19",
     "https://www.wistv.com/2026/05/19/ferrara-candy-company-breaks-ground-orangeburg/", "High (facts)"],
    ["2026-07-27", "Woodruff", "Spartanburg", "SC", "BMW Group — Plant Woodruff high-voltage battery assembly", "300 (part of $1.7B multi-year investment)", "~$700M (Woodruff portion of $1.7B total)",
     "Not disclosed; Estimated/Inferred sub-$100k (comparable BMW SC production/assembly wages typically $50k-$80k; battery-plant role mix may skew slightly higher but unconfirmed)", "BMW announced completion of its $1.7B South Carolina investment 2026-06-30/07-02, including the new Plant Woodruff battery facility; first fully-electric US-built BMW (iX5) production slated late 2026", "2026-06-30",
     "https://spectrumlocalnews.com/sc/south-carolina/news/2026/07/02/south-carolina-bmw-investiment", "Med (jobs/date); Low (wage)"],
    ["2026-07-27", "Durham", "Durham", "NC", "Aspida Financial Services — HQ expansion (pre-window; tracked for a converting milestone)", "1,000 (proj., hiring 2028-2032)", "$28M+",
     "$137,288 avg (stated) — clears the $100k bar", "Meets the job-count and wage thresholds outright, but the only announcement (2025-11-19) and its $21.8M JDIG-style incentive predate the window; no in-window flagship-site-selection or groundbreaking milestone found this cycle — watching for one to convert to Ranked", "2025-11-19",
     "https://www.commerce.nc.gov/news/press-releases/2025/11/19/financial-services-company-expand-durham-headquarters-1000-new-jobs", "High (facts); N/A (timing)"],
    ["2026-07-27", "Chatham County", "Chatham", "NC", "VinFast — EV plant (jobs cut; state suing to reclaim site)", "1,400 (cut from 7,500 proj.)", "$4.0B (orig.; incentive up to $1.2B if met)",
     "~$51,096 avg (Estimated/Inferred; well under $100k)", "MATERIAL RISK: on 2026-03-18 VinFast cut its job projection to 1,400 and said construction resumes in 2026 (production targeted 2028); on 2026-05-21 NC AG Jeff Jackson sued VinFast to reclaim the Chatham County site and recoup incentives after VinFast missed its Jan 2024 construction deadline, its July 2026 operations deadline, and the 1,750-jobs-by-end-2026 requirement", "2026-05-21",
     "https://www.axios.com/local/raleigh/2026/05/21/north-carolina-sues-vinfast-to-take-back-control-of-chatham-county-land", "High (facts); wage sub-$100k disqualifies Ranked"],
]

WATCH = WEEK1_WATCH + WEEK2_WATCH + WEEK3_WATCH + WEEK4_WATCH
...
# ---- Week 4 (2026-07-27) ----
WEEK4_EXCLUDED = [
    ["2026-07-27", "Maersk North American HQ", "Charlotte", "NC", "520", "2025-11-18", "Pre-window; NC's Economic Investment Committee formally approved (2026-02-24/25) shifting the hiring window to 2027-2029 — still a delay, not qualifying forward movement; wage $100,962 stated", "https://businessnc.com/maersk-delays-charlotte-headquarters-plan-hiring-520-workers-by-1-year/"],
    ["2026-07-27", "Scout Motors HQ (Plaza Midwood)", "Charlotte", "NC", "1,200", "2025-11-12", "Pre-window; no confirmed dated in-window milestone found again this cycle (no groundbreaking/permit date located)", "https://www.detroitnews.com/story/business/autos/2025/11/14/scout-motors-rolls-into-charlotte-5-key-things-about-the-automaker/87270881007/"],
    ["2026-07-27", "Pallidus (PROJECT CANCELLED)", "Rock Hill / York Co.", "SC", "0 (was 405)", "2026", "REVERSAL: Pallidus scrapped its $443M Rock Hill/York Co. HQ-and-manufacturing relocation, laid off 37 employees (44% of workforce), and is pivoting back to Albany, NY amid weak silicon-carbide demand", "https://www.manufacturingdive.com/news/pallidus-cancel-rock-hill-south-carolina-semiconductor-plant-hq-relocation"],
    ["2026-07-27", "PSA Airlines", "Charlotte (CLT)", "NC", "~400 (450+ on-site)", "2026-03-25", "Grand opening confirmed 2026-03-25; Charlotte-area average salary $44,638 — well under $100k (pilots average ~$107k but are a minority of roles)", "https://www.qcnews.com/charlotte/psa-airlines-opens-charlotte-headquarters-bringing-400-jobs-and-boost-to-nc-economy"],
    ["2026-07-27", "IKO North America", "Chester Co.", "SC", "~180", "2026-03", "Grand opening (production start) held March 2026; jobs remain ~180 — still below the 200-job Watch floor", "https://www.iko.com/na/iko-celebrates-grand-opening-of-new-fiberglass-and-fiberglass-mat-manufacturing-facilities-in-south-carolina"],
    ["2026-07-27", "Compass Datacenters", "Statesville (Iredell)", "NC", "~250", "2025-08", "No new 2026 milestone found again this cycle", "n/a"],
    ["2026-07-27", "Snider Fleet Solutions (REMOVED FROM WATCH)", "Indian Land (Lancaster)", "SC", "167", "2023-05", "CONFIRMED STALE: original announcement dates to May 2023; no 2026 activity found in a dedicated re-check — removed from active Watch tracking this cycle", "https://governor.sc.gov/news/2023-05/snider-fleet-solutions-relocating-headquarters-lancaster-county"],
    ["2026-07-27", "Bosch — Dorchester Co. electric motors", "Dorchester", "SC", "n/d (workforce 1,500->1,800)", "n/d", "Expansion remains paused amid EV demand downturn; no discrete new-jobs announcement or resumption found", "https://www.postandcourier.com/business/bosch-dorchester-electric-vehicles-rivian-expansion/article_265b1c36-ab6c-11ef-b047-3b784368d210.html"],
    ["2026-07-27", "Southeastern Container", "Enka-Candler (Buncombe)", "NC", "12 (new)", "2026-02-19", "$31M modernization confirmed, but only 12 new jobs at $32.90/hr (~$68,400/yr) — below both the 200-job Watch floor and the wage bar", "https://www.ashevillechamber.org/news-events/press-releases/southeastern-container-expands-buncombe-county-headquarters-and-manufacturing-operations"],
    ["2026-07-27", "Walmart — Mebane distribution center", "Alamance", "NC", "450", "2025-09-30", "Confirmed via current job postings: average pay ~$14.79/hr (~$30,700/yr) — well under $100k", "https://www.ziprecruiter.com/Jobs/Walmart-Distribution-Center/-in-Mebane,NC"],
    ["2026-07-27", "\"3 medical textile manufacturers\" (unnamed)", "Winston-Salem (Forsyth)", "NC", "600+ (aspirational)", "2026", "Still no companies named as a set; aggregate/speculative claim; best partial matches (GMAX Industries, Tex-Tech Industries) are both pre-window and sub-200 jobs individually", "n/a"],
    ["2026-07-27", "\"Barclays 1,500 jobs, North Hills\" (unverified)", "Raleigh (Wake)", "NC", "1,500 (claimed)", "unverified", "Re-checked again this cycle: still unverifiable — sole source is a non-authoritative relocation/SEO site (arcrelocation.com); no corroboration from Barclays, WRAL, Axios, NC Commerce, or the Governor's office", "https://arcrelocation.com/companies-moving-to-raleigh/"],
    ["2026-07-27", "Novo Nordisk speculative Four Oaks expansion", "Johnston", "NC", "~500 (speculative)", "2025-10 (cancelled)", "Re-confirmed cancelled/shelved; company's active NC investment is concentrated in its separate Clayton (Johnston Co.) facility", "https://jocoreport.com/major-four-oaks-pharmaceutical-project-cancelled/"],
    ["2026-07-27", "Kempower (EV charger manufacturer)", "Durham", "NC", "0 (was ~306 committed)", "2026-07", "REVERSAL: company confirmed it will not meet its ~306-job Durham commitment; NC ended its tax incentives as a result", "https://www.pressreader.com/usa/the-herald-sun/20260716/281560887555485"],
    ["2026-07-27", "Biogen $2B RTP manufacturing investment", "Durham/Wake (RTP)", "NC", "n/d", "2025-07-21", "Pre-window (30th-anniversary announcement); company gave no job-count estimate tied to the investment", "https://www.wral.com/business/biogen-manufacturing-2-billion-july-2025/"],
    ["2026-07-27", "Amgen (2nd facility)", "Holly Springs (Wake)", "NC", "370", "2024-12", "Pre-window; wage >$91k but <$100k; no in-window update found", "https://www.wral.com/story/amgen-to-add-370-jobs-as-part-of-1b-investment-in-holly-springs-nc-officials-say/21754490/"],
    ["2026-07-27", "Fujifilm Diosynth Biotechnologies", "Holly Springs (Wake)", "NC", "680", "2024-04-11", "Pre-window; no in-window update found", "https://www.commerce.nc.gov/news/press-releases/2024/04/11/fujifilm-diosynth-biotechnologies-expands-holly-springs-facility-create-one-largest-end-end-cell"],
    ["2026-07-27", "Eli Lilly", "RTP", "NC", "100+", "2024", "Pre-window; sub-500 jobs regardless", "https://investor.lilly.com/news-releases/news-release-details/lilly-plans-invest-additional-450-million-manufacturing-site"],
    ["2026-07-27", "Ypsomed", "Holly Springs (Wake)", "NC", "62", "2026", "Sub-200 jobs; well below Watch floor", "https://www.wake.gov/news/ypsomed-announces-plans-invest-1954-m-creating-62-new-jobs-holly-springs"],
    ["2026-07-27", "Audemars Piguet", "Raleigh (Wake)", "NC", "105", "2025", "Pre-window; sub-200 jobs and wage $92,376 (<$100k)", "https://www.wral.com/story/luxury-watch-brand-audemars-piguet-to-invest-22-million-and-create-105-jobs-in-raleigh/21202535/"],
    ["2026-07-27", "AdvanceTEC", "Johnston County", "NC", "160", "2026-07-07", "In-window groundbreaking confirmed, but 160 jobs remains below the 200-job Watch floor; wage $90k avg (<$100k)", "https://hoodline.com/2026/07/french-cleanroom-giant-drops-160-high-paying-jobs-into-johnston-county/"],
    ["2026-07-27", "Ziehl-Abegg Inc. — North American HQ", "Winston-Salem (Forsyth)", "NC", "500+ (growing from ~200)", "unconfirmed", "Milestone timing (HQ opening / headcount crossing 500) could not be confirmed as falling inside this window — flagged for verification next cycle rather than asserted", "https://fanpost.ziehl-abegg.com/en/detail/new-headquarters-with-high-tech-production-plant-and-hundreds-of-new-jobs"],
    ["2026-07-27", "American Eagle Outfitters", "Rowan Co. (Salisbury)", "NC", "200+", "2026-07-17", "Distribution hub confirmed; best-paid roles (~70 mgmt/maintenance) average only $57,351 — low-wage-only despite clearing the 200-job floor", "https://www.salisburypost.com/2026/07/17/fly-like-an-eagle-famous-outfitters-to-invest-41m-create-200-jobs-in-rowan-county"],
    ["2026-07-27", "Cheerwine / Piedmont Cheerwine Bottling", "Rowan Co.", "NC", "~100", "2026", "Sub-200 jobs; no high-wage signal", "https://hoodline.com/2026/06/cheerwine-s-7-million-salisbury-score-set-to-super-size-rowan-county-jobs"],
    ["2026-07-27", "Huntington Bank Carolinas branch expansion", "Multi (Charlotte/Raleigh/Winston-Salem/Charleston/Columbia/Greenville)", "NC/SC", "~350 (multi-state)", "2026-03-06", "Vague/diffuse multi-state aggregate spanning 55 branches, not a single site/project; bank-branch roles unlikely to average $100k+", "https://www.axios.com/local/charlotte/2026/03/06/banks-branch-expansion-huntington"],
    ["2026-07-27", "Corvid Technologies", "Mooresville (Iredell)", "NC", "367", "2018", "Confirmed stale/recycled 2018 announcement; no in-window update found", "https://www.mooresvilletribune.com/news/mooresville-chosen-for-367-job-headquarters"],
    ["2026-07-27", "LPL Financial", "Fort Mill (York Co.)", "SC", "3,000", "2014", "Stale/recycled announcement from 2014; no in-window (2026) milestone found", "n/a"],
    ["2026-07-27", "Costco", "Indian Land (Lancaster Co.)", "SC", "n/d", "unconfirmed", "Speculative; no official confirmation of a new warehouse/location found", "n/a"],
    ["2026-07-27", "JGA Space & Defense", "Huntersville (Mecklenburg)", "NC", "~40", "2026", "Sub-200 jobs", "n/a"],
    ["2026-07-27", "Albemarle — Richburg lithium hydroxide plant", "Chester Co.", "SC", "307", "2023-03", "Project remains paused since March 2024 due to falling lithium prices; no evidence of a resumed in-window milestone; also sub-500 jobs regardless", "https://scdailygazette.com/2024/03/18/major-electric-vehicle-lithium-project-paused-in-south-carolina/"],
    ["2026-07-27", "Bank of America / Wells Fargo / Truist", "Charlotte", "NC", "- (cuts)", "2026-01-16", "LAYOFFS/job cuts (AI-driven headcount reduction) — excluded per rules (opposite of qualifying criteria)", "https://www.axios.com/local/charlotte/2026/01/16/bank-america-wells-fargo-ai-job-cuts"],
    ["2026-07-27", "Woodward, Inc. — aerospace actuation manufacturing", "Greer (Spartanburg Co.)", "SC", "275", "date conflict (2025-09 vs 2026-02, unresolved)", "Date conflict could not be resolved this cycle (SC Governor's office URL slug reads Sept. 2025, one search result suggested Feb. 2026); excluded pending verification rather than asserted either way", "https://governor.sc.gov/news/2025-09/woodward-inc-selects-spartanburg-county-establish-new-manufacturing-site-south"],
    ["2026-07-27", "ElringKlinger — EV battery components expansion", "Easley (Pickens Co.)", "SC", "294", "2025-10-29", "Pre-window; no in-window update found", "https://www.postandcourier.com/greenville/news/elringklinger-auto-supplier-easley-plant/article_d5a55a73-946a-44e3-a2c7-d47669288ac3.html"],
    ["2026-07-27", "Cielo Digital Infrastructure", "Cherokee Co.", "SC", "30", "2025-06", "Sub-200 jobs; pre-window announcement/tax-break approval", "https://governor.sc.gov/news/2025-06/cielo-digital-infrastructure-selects-cherokee-county-first-south-carolina-development"],
    ["2026-07-27", "Numerous sub-200-job items (Detpak USA, Fortified Solar, Idealworks, Shamrock Technologies, Advanced Metalworks, Eastern Engineered Wood, Hydrite Chemical, Coastal Precast, Peabody Engineering, KP Components, Xoted Biotechnology Labs, United Composite Materials)", "Various Upstate SC", "SC", "13-151 each", "2025-2026", "Below Watch floor regardless of window", "n/a"],
    ["2026-07-27", "Numerous sub-200-job items (AVANTech, Eastover Chips, AVM Group, Hoffman & Hoffman Lexington, WiJo Pouches North America, Techo-Bloc, ALLTAPE Adhesive Mfg, Leonardo DRS, Modus21)", "Various Midlands/Lowcountry", "SC", "27-170 each", "2025-2026", "Below Watch floor and/or recycled old news with no in-window update; Ritedose Corp (Richland) flagged but unverified before search budget exhausted", "n/a"],
    ["2026-07-27", "Numerous sub-200-job items (Sumitomo Forestry America, Alamance Foods, Hoffman & Hoffman Greensboro, Cascade Die Casting, Torvan Medical, Swamp Rider, Team LaunchPoint, GMAX Industries)", "Various Triad", "NC", "12-135 each", "2025-2026", "Below Watch floor and/or sub-$100k wage and/or pre-window", "n/a"],
    ["2026-07-27", "Alzchem Group AG (new US production facility)", "Bushy Park / Goose Creek (Berkeley Co.)", "SC", "Not disclosed", "~2026-07-20", "Job count and investment figures not captured before this cycle's search budget was exhausted — flagged as a priority follow-up rather than scored on incomplete data", "n/a"],
    ["2026-07-27", "Jewelers Mutual Insurance \"Project Diamond\" — innovation hub", "Raleigh (Wake)", "NC", "200 (phased 2025-2029)", "unconfirmed", "Wage and precise announcement date could not be confirmed this cycle (source not independently fetchable) — flagged for a dedicated follow-up search next cycle rather than scored on incomplete data", "n/a"],
]

EXCLUDED = WEEK1_EXCLUDED + WEEK2_EXCLUDED + WEEK3_EXCLUDED + WEEK4_EXCLUDED
...
SOURCES = [
    ...
    ["Fort Mill Sun — Rock Hill City Council coverage", "journal", "https://www.fortmillsun.com/", "York Co. SC", "Octapharma final 7-0 city-council approval, 2026-07-23"],
    ["Aviation Week / FlightGlobal", "trade_journal", "https://aviationweek.com/", "National aerospace", "JetZero-EXIM $3B financing Letter of Interest"],
    ["Hoodline", "journal", "https://hoodline.com/", "NC/SC metro", "Citigroup Ballantyne grand opening/hiring ramp; Boom Supersonic risk update"],
    ["Businesswire — Ralliant press release", "company_primary", "https://www.businesswire.com/", "Company", "Ralliant global HQ opening, North Hills"],
    ["Axios Raleigh", "journal", "https://www.axios.com/local/raleigh/", "NC Triangle", "WakeMed/Atrium delay; VinFast lawsuit; Aspida Durham HQ"],
    ["Carolina Journal", "journal", "https://www.carolinajournal.com/", "NC statewide", "Wolfspeed Siler City layoffs"],
    ["Manufacturing Dive", "trade_journal", "https://www.manufacturingdive.com/", "National mfg", "Pallidus project cancellation, Rock Hill/York Co."],
    ["Charleston Digital", "journal", "https://www.charlestondigital.com/", "SC Lowcountry", "Google SC $9B data-center expansion detail"],
    ["Spectrum Local News", "journal", "https://spectrumlocalnews.com/", "NC/SC", "BMW $1.7B SC investment completion; AbbVie recap"],
    ["Post and Courier — Spartanburg bureau", "journal", "https://www.postandcourier.com/spartanburg/", "Upstate SC", "NorthMark Project Moc-1 hearing; AIRSYS HQ opening"],
    ["WECT / WilmingtonBiz", "journal", "https://www.wect.com/", "New Hanover Co. NC", "Amazon-Corning fiber-optics Wilmington detail"],
    ["9to5Mac", "trade_journal", "https://9to5mac.com/", "National tech", "Apple RTP incentive-extension date correction (2025-11-25)"],
    ["SC Daily Gazette", "journal", "https://scdailygazette.com/", "SC statewide", "SC Ports Leatherman confirmed pause; Boeing 787 rate"],
]
...
WEEK4_SCORE_DETAIL = [
    ["2026-07-27", "SMBC Group (Charlotte)", 93, "Unchanged; no new milestone this cycle."],
    ["2026-07-27", "Octapharma (Rock Hill)", 90, "Rock Hill City Council's unanimous 7-0 approval (2026-07-23) resolves the outstanding city-vote risk that had discounted this deal for two consecutive cycles; +3 for the removal of that execution-certainty discount."],
    ["2026-07-27", "Scout Motors (Blythewood)", 86, "Unchanged: Training Center opened, 600+ hired, first vehicle body weld completed — genuine hiring/construction progress — offset by continued signals that customer deliveries may slip toward 2028."],
    ["2026-07-27", "AbbVie (Durham)", 84, "Unchanged; no new milestone this cycle."],
    ["2026-07-27", "Capital Group (Charlotte)", 81, "Unchanged; lease-commencement date confirmed but not a new milestone."],
    ["2026-07-27", "Genentech (Holly Springs)", 80, "Unchanged; no new milestone this cycle."],
    ["2026-07-27", "JetZero (Greensboro)", 79, "Unchanged: EXIM Letter of Interest for up to $3B in financing is a modest, explicitly non-binding positive signal that does not resolve the JDIG-amendment hiring-ramp delay; score held flat."],
    ["2026-07-27", "Novartis (Durham/Morrisville)", 77, "Unchanged; no new milestone this cycle."],
    ["2026-07-27", "Citigroup (Charlotte/Ballantyne)", 74, "NEW to Ranked this cycle: 510 jobs, $131,832 stated wage, and a confirmed in-window hiring-ramp to ~400/510 roles constitute genuine forward execution (not merely a delayed pre-window commitment), reversing three cycles of exclusion; scored below other ranked deals given modest capex ($16.1M) and first-time-ranked low repeat-momentum."],
]
SCORE_DETAIL = WEEK1_SCORE_DETAIL + WEEK2_SCORE_DETAIL + WEEK3_SCORE_DETAIL + WEEK4_SCORE_DETAIL

...
WINDOW = "2026-02-10 to 2026-08-10"  # trailing 6 months
...
WEEK4_RUNNING = [
    ...
    [REPORT_DATE, "Updated (resolved)", 2, 90, "Rock Hill / York Co.", "York", "SC",
    ...
    [REPORT_DATE, "Repeated (unverified this cycle)", 3, 86, "Blythewood / N. Columbia", "Richland", "SC",
    ...
    [REPORT_DATE, "Updated", 6, 80, "Greensboro / PTI Airport", "Guilford", "NC",
    ...
    [REPORT_DATE, "New", 8, 79, "Charlotte / Plaza Midwood", "Mecklenburg", "NC",
    ...
    [REPORT_DATE, "Repeated", 9, 77, "Durham / Morrisville", "Durham & Wake", "NC",
     "Novartis — API mfg building (investment increase)", "Adv. mfg / API production",
     "New facility (unchanged)", 700, "Projected (part of pre-window deal)",
     "$111,161 avg (stated)", "N/A — stated", "~$991M (incl. $220M API building)",
     "Part of original $771M package incentives", "Facility opening targeted 2027-2028",
...
WEEK4_WATCH = [
    [REPORT_DATE, "North Charleston", "Charleston", "SC", "SC Ports Authority — Leatherman Terminal (PAUSE STATUS UNCONFIRMED)", "400 direct + ~1,200 indirect", "$1.2B",
    ...
    [REPORT_DATE, "Cherokee Co. / Blacksburg", "Cherokee", "SC", "USA Rare Earth — rare-earth magnet plant", "~490", "$1.2B",
     ...
     "https://www.postandcourier.com/spartanburg/business/usa-rare-earth-blacksburg-sc-facility/article_2681ca76-7e5f-4a73-8a80-13231e38917f.html", "High"],
    [REPORT_DATE, "Spartanburg (former Kohler plant)", "Spartanburg", "SC", "NorthMark \"Project Moc-1\" — AI/HPC data center", "~150 FT at full operation", "$2.8B",
    ...
    [REPORT_DATE, "Greensboro / PTI Airport", "Guilford", "NC", "Boom Supersonic — Overture assembly (AT RISK)", "<=500 currently; must hit 500 by 12/31/26", "~$50M (hangar)",
     ...
     "https://www.prismnews.com/local/guilford-nc/boom-supersonics-greensboro-factory-sits-idle-as-state", "High (risk)"],
    [REPORT_DATE, "Rowan County", "Rowan", "NC", "American Eagle Outfitters (formerly code-named \"Project Rack\" — identity now confirmed)", "200+ (state figure; county vote cited 258)", "$41M",
    ...
    [REPORT_DATE, "Charlotte (CLT airport)", "Mecklenburg", "NC", "Averitt — logistics campus", "~230 (revised from 211)", "$200M",
    ...
    [REPORT_DATE, "Burlington / Alamance-Guilford line", "Alamance", "NC", "NEW — Ahold Delhaize USA (Food Lion parent) — distribution center", "500-505", "$860M",
    ...
    [REPORT_DATE, "Pender / New Hanover", "Pender (+New Hanover)", "NC", "NEW — Amazon — robotics fulfillment center", "1,000+", "$350M",
    ...
    [REPORT_DATE, "Durham", "Durham", "NC", "NEW — Aspida Financial Services — HQ expansion", "1,000 (proj.)", "$28M+",
    ...
    [REPORT_DATE, "Raleigh / North Hills", "Wake", "NC", "NEW — Jewelers Mutual Group", "200", "$5.85M",
    ...
    [REPORT_DATE, "Garner", "Wake", "NC", "NEW — Gregory Poole Equipment Co. — HQ relocation", "500+ (5 yr)", "$347M",
    ...
    [REPORT_DATE, "Greenville", "Greenville", "SC", "GE Vernova — gas turbine mfg (AI/data-center power supply chain)", "650 total planned", "$160M (Greenville)",
...
# ---- Week 4 (2026-08-10) ----
WEEK4_EXCLUDED = [
    [REPORT_DATE, "VinFast (INCENTIVE TERMINATED)", "Chatham Co.", "NC", "1,400 (scaled back from 7,500)", "2026-07-27 to 07-31", "NEW REVERSAL: Chatham County commissioners voted to terminate the $400M incentive agreement after VinFast failed to hit its 1,750-job/~$700M-invested threshold; state separately suing to reclaim the Moncure site; no production has begun", "https://www.wral.com/business/vinfast-agreement-canceled-chatham-county-north-carolina-july-2026/"],
    [REPORT_DATE, "Kempower (JDIG CANCELLED)", "Durham/RTP", "NC", "306 (pledge; only ~100 employed)", "2026-07 (mid-July)", "NEW REVERSAL: NC Commerce cancelled Kempower's JDIG after the company missed hiring targets (156 jobs required by end-2025); company continues operating at reduced scale, citing loss of federal EV tax credits and softer US EV demand", "https://hoodline.com/2026/07/durham-ev-plant-slams-brakes-on-hiring-as-state-yanks-job-grant/"],
    [REPORT_DATE, "Maersk North American HQ", "Charlotte", "NC", "520", "2025-11-18", "Pre-window; in-window milestone remains a 1-year hiring delay (2027-2029); rechecked this cycle, no new forward movement found", "https://businessnc.com/maersk-delays-charlotte-headquarters-plan-hiring-520-workers-by-1-year/"],
    [REPORT_DATE, "Citigroup", "Charlotte / Ballantyne", "NC", "510", "2025-07-08", "Pre-window; rechecked this cycle — office headcount grew from ~350 to ~860 by April 2026, but this is continued execution of the pre-window commitment, not a new 500+ award", "https://hoodline.com/2026/03/stein-hits-ballantyne-as-citi-bets-big-on-charlotte-jobs/"],
    [REPORT_DATE, "Compass Datacenters", "Statesville (Iredell)", "NC", "~250", "2025-08", "Rechecked this cycle; no 2026 milestone found; remains pre-window", "n/a"],
    [REPORT_DATE, "PSA Airlines", "Charlotte (CLT)", "NC", "~400", "2026-03-19", "Rechecked this cycle; grand opening remains the only milestone and ties to a pre-window relocation commitment", "https://psaairlines.com/psa-airlines-celebrates-grand-opening-of-charlotte-headquarters-underscoring-economic-and-workforce-impact-across-north-carolina/"],
    [REPORT_DATE, "EG Group global HQ relocation", "Charlotte", "NC", "Not disclosed", "2025-08-20", "Pre-window; no disclosed job count or capex for the Charlotte component", "https://www.aol.com/news/scout-motors-midst-launching-charlotte-090500610.html"],
    [REPORT_DATE, "Daimler Truck Financial Services USA", "Ballantyne (Charlotte)", "NC", "276", "2025-05-27", "Pre-window; sub-500; no in-window update", "n/a"],
    [REPORT_DATE, "RXO", "Charlotte", "NC", "216", "2024-11-26", "Pre-window; wage $89,769 (<$100k)", "n/a"],
    [REPORT_DATE, "Albemarle \"Mega-Flex\" lithium plant", "Chester Co.", "SC", "300", "2026-02 (earnings call)", "Confirmed still paused per CEO's Feb. 2026 earnings-call comments citing depressed lithium prices — no construction, engineering work stopped", "n/a"],
    [REPORT_DATE, "E&J Gallo Winery", "Chester Co.", "SC", "496", "2021-06", "Recycled 2021 news; no in-window update found", "https://governor.sc.gov/news/2021-06/e-j-gallo-winery-establishing-new-east-coast-facility-chester-county"],
    [REPORT_DATE, "Honeywell HQ", "Charlotte", "NC", "750", "2018", "Long-completed 2018 announcement; no relevance to the window", "n/a"],
    [REPORT_DATE, "\"Barclays 1,500 jobs, North Hills\" (unverified)", "Raleigh (Wake)", "NC", "1,500 (claimed)", "unverified", "Re-checked this cycle: traces to a 2024 Instagram post about existing NC card-services operations, not a 2026 relocation — still unverifiable, no authoritative source found", "n/a"],
    [REPORT_DATE, "Novo Nordisk speculative Four Oaks expansion", "Johnston", "NC", "~500 (speculative)", "2025-10 (cancelled)", "Confirmed still cancelled after an annexation vote in Oct. 2025; also pre-window", "n/a"],
    [REPORT_DATE, "Fujifilm Diosynth", "Holly Springs (Wake)", "NC", "680 (2024 expansion)", "2025-09", "Grand opening was Sept. 2025, pre-window; no in-window update found", "n/a"],
    [REPORT_DATE, "Amgen (2nd facility)", "Holly Springs (Wake)", "NC", "370", "2024-12", "Pre-window; sub-500 jobs", "n/a"],
    [REPORT_DATE, "Science 37", "Morrisville (Wake)", "NC", "250", "2026-06-16", "Company being acquired/taken private (~$375M sale) — reversal-adjacent, not a growth signal", "n/a"],
    [REPORT_DATE, "Snider Fleet Solutions (REMOVED from Watch)", "Indian Land (Lancaster)", "SC", "167", "2023", "Confirmed stale 2023 item; no developments found in 3+ years despite repeated rechecks — removed from active Watch tracking this cycle", "https://www.qcnews.com/news/u-s/lancaster-county/major-manufacturing-company-moving-to-indian-land/"],
    [REPORT_DATE, "Boom Supersonic \"Rolls-Royce engine partnership collapse\" (rumor, debunked)", "Greensboro", "NC", "n/a", "n/a", "An AI-summarized search result implied this was a 2026 event; underlying sources trace to 2022 — not a current development, excluded as a data-quality catch", "n/a"],
    [REPORT_DATE, "Sub-200-job items (AdvanceTEC/Clayton, Innovative Construction Group/Siler City, CITEL/Hillsborough, GMAX Industries/Forsyth, Superion/Guilford, Walmart Gaston, Fit Precast)", "Various NC", "NC", "36-300 each", "2025-2026", "Below Watch floor and/or wage well under $100k regardless of window", "n/a"],
]
...
WEEK4_SCORE_DETAIL = [
    [REPORT_DATE, "SMBC Group (Charlotte)", 93, "Unchanged; no new milestone this cycle (third consecutive quiet cycle)."],
    [REPORT_DATE, "Octapharma (Rock Hill)", 90, "Rock Hill City Council voted 7-0 to approve amended tax-share terms (2026-07-23), resolving the deal's chief outstanding execution risk; SC awarded a $65M Closing Fund grant to York County; deal now described as fully finalized — net +3 for removed deal-certainty discount."],
    [REPORT_DATE, "Scout Motors — EV plant (Blythewood)", 86, "Carried forward unchanged — this cycle's SC Midlands/Lowcountry recheck could not be completed due to web-search tool-budget exhaustion; no negative signal found, but also not independently reverified this cycle."],
    [REPORT_DATE, "AbbVie (Durham)", 84, "Unchanged; no new milestone this cycle."],
    [REPORT_DATE, "Capital Group (Charlotte)", 81, "Unchanged; no new milestone this cycle."],
    [REPORT_DATE, "JetZero (Greensboro)", 80, "Physical construction now confirmed underway (NC Composite Center, HITT Contracting as general contractor) beyond the groundbreaking ceremony already credited last cycle; net +1 for reduced execution-risk discount, still capped by the extended hiring ramp (full target 2037)."],
    [REPORT_DATE, "Genentech (Holly Springs)", 80, "Unchanged; no new milestone this cycle."],
    [REPORT_DATE, "Scout Motors — Global HQ (Charlotte)", 79, "New to Ranked: 1,200 jobs + stated $153,978 wage (well above county avg) + urban Plaza Midwood fit; discounted for Med confidence (in-window milestone is a preliminary land-development filing, not a permit or groundbreaking) and zero repeat-momentum as a first-time-ranked entry."],
    [REPORT_DATE, "Novartis (Durham/Morrisville)", 77, "Unchanged; no new milestone this cycle."],
]
...
SUMMARY_LINES = [
    ...
    ("Top mover", "Rock Hill / York Co. (SC) — Octapharma 'Project Palmetto Rock', score 90 (+3) — Rock Hill City Council voted 7-0 on 2026-07-23 to approve amended tax-share terms, resolving the deal's last outstanding governmental hurdle; deal now described as fully finalized"),
    ("Key takeaway", "Octapharma is now a closed deal, not a pending one. Scout Motors' Charlotte global HQ (distinct from its Blythewood, SC EV plant) is newly Ranked on an in-window land-development filing for a second office building. JetZero has moved from ceremonial groundbreaking to an active general contractor physically building the first facility. Two negative reversals hit the NC Triangle (VinFast incentive terminated in Chatham Co.; Kempower's JDIG cancelled in Durham/RTP)."),
    ("Coverage gap — READ", "This session's shared web-search tool budget (200 calls) was exhausted before the SC Midlands/Lowcountry research pass could run at all, and before the Upstate SC pass could complete more than 4 of its planned ~25 searches. Every SC Midlands/Lowcountry entry (Scout Motors' Blythewood plant, SC Ports Leatherman Terminal, AMAROK, Ferrara Candy, Boeing 787, HII, Google) and several Upstate SC watch items are carried forward from 2026-07-13 UNVERIFIED this cycle — flagged in both the report and this workbook. No numbers were invented; see the report's Appendix for full detail."),
    ("Window note", "Trailing 6 months now runs 2026-02-10 to 2026-08-10."),
    ("Data-quality note", "SC Ports' announced Aug. 1, 2026 pause of Leatherman Terminal operations (reported 2026-06-25) could not be confirmed as having taken effect this cycle due to the coverage gap above — this is the #1 priority recheck for next cycle."),
    ("Week-over-week", "8 of 8 prior-ranked deals remain qualifying, plus 1 new (Scout Motors Global HQ, Charlotte) — 9 total. 1 updated/resolved (Octapharma, +3), 1 updated (JetZero, +1), 5 repeated (SMBC, AbbVie, Capital Group, Genentech, Novartis), 1 repeated-but-unverified (Scout Motors EV plant, Blythewood). None removed from Ranked. Snider Fleet Solutions removed from Watch (confirmed stale)."),
]

...
WINDOW = "2026-02-03 to 2026-08-03"  # trailing 6 months
...
WEEK4_RUNNING = [
    ...
    [REPORT_DATE, "Gaining Momentum", 2, 90, "Rock Hill / York Co.", "York", "SC",
     "Octapharma — \"Project Palmetto Rock\" HQ + manufacturing campus", "Biopharmaceutical (plasma fractionation)",
     "City-level approval closes out the deal", 1500, "Projected (1,200 new + 300 relocated)",
     "$141,502 avg HQ / $102,752 avg mfg (both stated, county-presented figures)", "N/A — stated", "$1.5B",
     "Fee-in-lieu-of-tax, assessment ratio cut to 4%; land sale of 50 ac in Palmetto Research Park to Octapharma",
     "Rock Hill City Council voted UNANIMOUSLY 7-0 on 2026-07-23 to approve both the land sale and the amended tax-incentive agreement, resolving the prior cycle's single outstanding risk; deal is now fully closed on both county and city sides. No groundbreaking date set yet; construction expected to start 2027.",
     "2026-07-23", "https://www.wbtv.com/2026/07/23/rock-hills-octapharma-projects-moved-forward-what-we-know/",
     "High", "Office/HQ + biopharma mfg", "Suburban",
     "Dual-tier: $141k HQ roles -> luxury for-sale/Class-A in Rock Hill/Fort Mill; $102k mfg roles -> premium workforce-plus rental/TH.",
     "The prior cycle's key open question (Rock Hill City Council's vote) is now resolved unanimously in favor — execution-risk discount removed, score up +3. Council members publicly criticized York County over the tax-split fight during the same meeting, but the vote itself was 7-0 to proceed. Next milestone to watch: a groundbreaking date."],

    [REPORT_DATE, "Updated", 3, 85, "Blythewood / N. Columbia", "Richland", "SC",
     "Scout Motors — EV assembly plant (active hiring ramp; timeline slips further)", "Automotive / EV manufacturing",
     "Hiring event held as scheduled; timeline confirmation", 4000, "Projected (~1,400 hired companywide; 600+ in SC)",
     "$30-$34/hr maintenance tech / $33.50-$37.50/hr senior maintenance tech (stated); salaried roles mixed/undisclosed", "Estimated/Inferred mix supports above-median HH income",
     "$2.0B (+$25M training center)", "State/local package (2023); $25M readySC", "Pre-hire/interview events for 70+ maintenance-tech roles proceeded as scheduled the week of 2026-07-29; Traveler production now explicitly targeted late 2027 with customer deliveries pushed to early 2028 (a further, more concrete slip vs. last cycle's softer 'trending toward 2028')",
     "2026-07-29", "https://www.wltx.com/article/news/local/scout-motors-hiring-maintenance-technicians-blythewood-plant/101-1ca4c9f6-a045-44a2-8c89-8a427cd766e2",
     "High", "Auto mfg + salaried eng.", "Suburban",
     "Bifurcated: salaried/professional -> higher-income for-sale & Class-A; hourly base -> workforce/missing-middle rental in N. Richland/Fairfield.",
     "Hiring event proceeded on schedule (positive), but the customer-delivery timeline slip to 'early 2028' is now stated plainly rather than softly implied — net -1 for confirmed further timeline risk even as near-term hiring signal stays strong."],
    ...
    [REPORT_DATE, "Repeated", 5, 81, "Charlotte", "Mecklenburg", "NC",
     "Capital Group — East Coast operations hub", "Investment mgmt / finance + tech",
     "Wage figure confirmed (stated, not inferred)", 600, "Projected",
     ...
     "High", "Office — finance/tech", "Urban-suburban",
     "High-skill eng/data workforce -> walkable South End/Uptown & inner-suburban Class-A and for-sale TH.",
     "No new in-window milestone found this cycle; hiring doesn't begin until 2027."],
    ...
    [REPORT_DATE, "Gaining Momentum", 7, 80, "Greensboro / PTI Airport", "Guilford", "NC",
     "JetZero — aerospace plant (EXIM financing Letter of Interest)", "Aerospace / advanced manufacturing",
     "Financing milestone — EXIM Bank Letter of Interest", 14500, "Projected",
     "$89,340 avg (stated, 2025)", "N/A — stated (2025)", "$4.7B",
     "Transformative JDIG up to $1.018B / 37 yr; Guilford grant $75.9M / 20 yr; base period 2028-2037 (unchanged)",
     "JetZero and the U.S. Export-Import Bank signed a Letter of Interest on 2026-07-20 (at the Farnborough Airshow) to explore up to $3B in EXIM financing for the Greensboro campus — a capital-durability signal, not a jobs/wage change; hiring ramp still begins 2028-2029 per the prior JDIG amendment",
     ...
     "High (facts); Low (timeline)", "Aerospace mfg + eng.", "Suburban",
     "Same long-run scale; a $3B EXIM financing pathway strengthens confidence the megaproject reaches its full build-out even as near-term hiring stays on the 2028-2029 ramp.",
     "Construction/financing momentum continues even though no new jobs/wage figures moved this cycle — +1 for reduced execution-certainty risk on the capital side."],
...
# ---- Week 4 (2026-08-03) — carried-forward items updated + new items ----
WEEK4_WATCH = [
    [REPORT_DATE, "Cherokee Co. / Blacksburg", "Cherokee", "SC", "USA Rare Earth — rare-earth magnet plant", "~490", "$1.2B",
     "$24.50-$63/hr (stated)", "Formal site-selection/investment announcement confirmed 2026-06-02; still just under 500 jobs, no threshold-crossing update found; commissioning now targeted ~2028", "2026-06-02",
     "https://governor.sc.gov/news/2026-06/usa-rare-earth-inc-selects-cherokee-county-first-south-carolina-operation", "High"],
    [REPORT_DATE, "Laurens Co.", "Laurens", "SC", "Suniva — solar-cell plant", "564", "$350M",
     "Entry-level ~$23/hr; technicians $26-$36/hr (stated) — Estimated/Inferred blended avg ~$62k-$83k, below $100k", "Crosses 500 jobs but detailed wage-tier data confirms the bulk of roles fail the $100k bar; stays Watch. Operations still targeted 2027", "2026-04-14",
     "https://www.postandcourier.com/greenville/business/suniva-solar-cell-plant-laurens-sc/article_986c2fc2-2335-48cb-bd3c-92e89604c49c.html", "High"],
    [REPORT_DATE, "Columbia / BullStreet", "Richland", "SC", "AMAROK — new HQ (perimeter security)", "296", "$69M",
     "Not disclosed; HQ/professional (portion likely $100k+)", "No update found this cycle", "2026-03-24",
     "https://www.postandcourier.com/columbia/business/columbia-sc-bullstreet-amarok-headquarters/article_73ea5904-fe8c-4048-b0a3-10417d1af35e.html", "High"],
    [REPORT_DATE, "Greensboro", "Guilford", "NC", "Lumentum — AI/data-center optics", "~400", "Hundreds of millions",
     "Not disclosed", "Ribbon-cutting confirmed 2026-04-29; production still targeted mid-2028; no further update this cycle", "2026-04-29",
     "https://greensboro.com/news/local/business/development/article_be1b2ff0-8a3c-463e-904e-78472c59db7a.html", "Med"],
    [REPORT_DATE, "Hendersonville", "Henderson", "NC", "BorgWarner — vertical-integration expansion", "378", "$100M",
     "$67,047 avg (stated; below $100k)", "No new update found this cycle", "2026-05-26",
     "https://www.commerce.nc.gov/news/press-releases/2026/05/26/governor-stein-announces-100-million-expansion-borgwarner-hendersonville", "High"],
    [REPORT_DATE, "Asheville / Arden", "Buncombe", "NC", "Eaton — Low Voltage Assembly expansion", "300", "Not disclosed",
     "'high-wage' but figure Not disclosed (Inferred mid-$60k-$80k)", "No new update found this cycle; remains 7th Helene-recovery manufacturer expansion", "2026-04-08",
     "https://www.ashevillechamber.org/news-events/press-releases/eaton-invests-in-workforce-growth-in-buncombe-county/", "High (jobs); Low (wage)"],
    [REPORT_DATE, "Kernersville", "Forsyth", "NC", "John Deere — excavator plant (relocating from Japan)", "150+", "$70M",
     "Not disclosed (Inferred skilled-mfg)", "Construction underway on west campus; opening still targeted 'next year'", "2026-01",
     "https://journalnow.com/news/local/business/development/article_b204fb94-5ff2-4618-9eba-6aee803fc2dc.html", "High"],
    [REPORT_DATE, "Liberty", "Randolph", "NC", "Toyota Battery Manufacturing NC (TBMNC) — EV/hybrid battery megaplant", "5,100 (proj. total); 3,000+ employed", "$13.9B",
     "$62,234 (stated; below $100k)", "Continued active hiring (70+ open roles as of Aug 2026); no wage or NC-specific investment update found this cycle", "2026-02",
     "https://allamerican.org/news/toyotas-north-carolina-battery-plant-brings-jobs/", "High (jobs); Low (wage)"],
    [REPORT_DATE, "Greensboro / PTI Airport", "Guilford", "NC", "Boom Supersonic — Overture assembly (AT RISK)", "≤500 currently; must hit 500 by 12/31/2026", "~$50M (hangar)",
     "Not disclosed", "No movement toward or away from the Dec 31, 2026 lease-default trigger found this cycle; hangar still described as largely idle; a July 2026 FAA supersonic-overland rulemaking (comment period closes 2026-08-17) is a regulatory tailwind, not a jobs signal", "2026-07",
     "https://www.prismnews.com/local/guilford-nc/boom-supersonics-greensboro-factory-sits-idle-as-state", "Med"],
    [REPORT_DATE, "Multi-site incl. Wilmington", "New Hanover+", "NC", "Amazon-Corning — fiber-optics partnership", "1,000 (multi-site, unallocated)", "Multi-billion (undisclosed NC-specific)",
     "avg >$65,000 (sub-$100k)", "Confirmed 2026-06-08; multi-year, multi-billion agreement; per-site allocation still not broken out", "2026-06-08",
     "https://www.wect.com/2026/06/08/amazons-data-center-push-fuels-1000-job-fiber-optic-agreement-with-corning/", "High"],
    [REPORT_DATE, "Arden", "Buncombe", "NC", "Pratt & Whitney (RTX) — casting foundry expansion", "325", "$285M",
     "$62,413 (stated)", "On track: equipment arrival end-2026 target unchanged, first parts still mid-2027", "2026-04",
     "https://businessnc.com/pratt-whitney-announces-285-million-expansion-325-more-jobs-for-buncombe-county/", "High"],
    [REPORT_DATE, "Asheboro", "Randolph", "NC", "Environmental Air Systems", "300", "$20M",
     "$55,133 (stated)", "No jobs/wage change; new incentive detail surfaced (~$5M total: $3.3M JDIG, $1.2M workforce training, $500K building re-use grant)", "2026",
     "https://edpnc.com/news/environmental-air-systems-randolph-county/", "High"],
    [REPORT_DATE, "Wilmington", "New Hanover", "NC", "GE Hitachi / Global Nuclear Fuel — GNF4 fuel line", "Not disclosed", "Not itemized",
     "Not disclosed", "GNF4 fabrication underway; new detail: GNF plans >$50M in safety/quality/production investment across this year and next; first lead-use assemblies contracted for 2026 deployment", "2026",
     "https://www.wilmingtonbiz.com/more_news/2025/10/09/global_nuclear_fuel_to_fabricate_new_nuclear_fuel_product_in_wilmington/26920", "Med"],
    [REPORT_DATE, "Whitsett", "Guilford", "NC", "NEW — Lenovo — server/AI manufacturing campus expansion", "~1,000 total target (up from ~600 current)", "$145M (up from original $77M pledge)",
     "$66,770 (2025-stated; sub-$100k)", "Ribbon-cutting held 2026-07-24 at the 'NC Smart Campus,' Whitsett; facility doubled to 890,000 sq ft, 35% more manufacturing capacity, 20MW power infrastructure for AI/HPC", "2026-07-24",
     "https://news.lenovo.com/pressroom/press-releases/lenovo-doubles-the-size-of-its-u-s-manufacturing-facility-in-north-carolina/", "High"],
    [REPORT_DATE, "Burlington", "Guilford/Alamance", "NC", "NEW — Ahold Delhaize USA / Food Lion — \"Project Titan\" distribution center", "505 (proj. by end of 2033)", "$860M",
     "~$60k-$62k avg (Estimated/Inferred; sub-$100k distribution-center wage)", "Guilford ($17.9M) and Burlington City ($21.5M) incentive packages approved; construction expected to begin 2026, operations 2029; crosses 500 jobs but wage clearly fails the higher-income-housing test", "2025-10 (approvals); 2026 construction start",
     "https://greensboro.com/news/local/business/employment/article_ce55534b-c262-47cf-b949-8cfda5828bf7.html", "Med"],
    [REPORT_DATE, "Wake Co. (aggregate)", "Wake", "NC", "County jobs pipeline (EDGE 7)", "~11,000 (pipeline)", "$11B",
     "Mixed (office-skewed)", "2026 outlook reconfirms the ~$11B/11,000-job pipeline; ~25% of prospects foreign-HQ'd (Japan, Germany, Switzerland)", "2026",
     "https://raleigh-wake.org/blog/2026-economic-development-outlook-forwake-county", "Med"],
    [REPORT_DATE, "Raleigh / Wendell / Knightdale", "Wake", "NC", "Siemens AG — power devices for AI/data centers", "350", "part of $165M",
     "Not disclosed", "New 101,000-sf Wendell facility confirmed online July 2026 as previously flagged; Knightdale's 100-jobs-by-end-2026 target not yet confirmed met", "2026-07",
     "https://www.wral.com/business/siemens-350-jobs-nc-sc-165m-investment-ai-data-centers-raleigh-wendell-march-2026/", "High"],
    [REPORT_DATE, "Siler City", "Chatham", "NC", "Wolfspeed — silicon-carbide fab (\"The JP\")", "1,800 (proj.)", "$5.0B",
     "$77,753 (stated, 2025)", "Q2 FY26 earnings (reported 2026-02-04) show Siler City underutilization costs rising ($26M->$47M YoY); new CEO pursuing 'operational discipline' (optimize installed capacity) over aggressive ramp — a slower, more measured hiring trajectory than previously implied. Company separately shut down its legacy Durham 150mm line (see Excluded)", "2026-02-04",
     "https://www.investing.com/news/transcripts/earnings-call-transcript-wolfspeeds-q2-2026-results-disappoint-stock-dips-93CH-4486298", "Med-High"],
    [REPORT_DATE, "Benson", "Johnston", "NC", "Vulcan Elements — magnet factory", "1,000 (proj.)", "$918.4M",
     "$81,932 (stated)", "Johnston Community College received a $3.6M GoldenLEAF grant; train-the-trainer instruction begins summer 2026 as scheduled; company secured a $620M federal loan plus a government equity stake, though a Feb-2026 site visit found the parking lot still largely empty ahead of a targeted Q1 2027 Benson-operations start", "2026",
     "https://www.thewirechina.com/2026/03/15/the-magnet-makers-vulcan-elements-rare-earths/", "Med-High"],
    [REPORT_DATE, "Wake County (statewide)", "Wake", "NC", "WakeMed / Atrium Health — proposed merger", "3,300 (statewide, 5 yr)", "$2.0B (Wake Co. portion)",
     "Not disclosed", "Wake County Commissioners voted 2026-05-04 to delay their decision by 90 days, landing the vote at approximately 2026-08-02 — essentially coincident with this report's cutoff; no confirmed outcome located as of this report date. HIGHEST-PRIORITY recheck for next cycle", "2026-05-04",
     "https://www.wake.gov/news/wake-county-commission-delays-vote-legal-documents-related-wakemed-atrium-health-strategic-combination", "High (timeline); Low (outcome)"],
    [REPORT_DATE, "RTP", "Wake", "NC", "Apple — RTP campus extension", "3,000 originally proj.; ~600-990 added to date", "$552M-$1B+ (paused)",
     "$187k (stated, 2021 award)", "No active construction found this cycle; new hiring commitments restart 2027 under the incentive-timeline extension. (Note: this session's sources date the extension itself to late Nov. 2025, not April 2026 as in the prior baseline — flagged for reconciliation)", "2025-11 (extension)",
     "https://9to5mac.com/2025/11/25/apple-granted-rare-timeline-extension-north-carolina-campus/", "Med"],
    [REPORT_DATE, "Raleigh / North Hills", "Wake", "NC", "Ralliant Corp. — global HQ launch", "180", "$2.1M",
     "$170k-$189k (stated)", "HQ officially opened 2026-03-05; 150 of the 180 targeted jobs already filled; hiring continues through 2029", "2026-03-05",
     "https://www.wral.com/business/technology/ralliant-launches-raleigh-global-hq-north-hills-march-2026/", "High"],
    [REPORT_DATE, "Durham", "Durham", "NC", "NEW — Aspida Financial Services — HQ expansion", "1,000", "$28M",
     "$137,288 avg (stated; Durham Co. avg is $97,531)", "HIGH-PRIORITY WATCH ADD: numerically clears both the 500-job and $100k-wage bars, but the announcement itself is dated 2025-11-19 — before this window opens — and no in-window (Feb-Aug 2026) milestone (lease signing, groundbreaking, hiring event) was found this cycle. Recommend promoting to Ranked the moment a genuine forward-moving in-window milestone surfaces", "2025-11-19",
     "https://www.commerce.nc.gov/news/press-releases/2025/11/19/financial-services-company-expand-durham-headquarters-1000-new-jobs", "High (facts); N/A (in-window trigger)"],
    [REPORT_DATE, "Holly Springs", "Wake", "NC", "NEW — Amgen — biomanufacturing site (headcount target)", "725 total by 2032 (site target)", "~$1.57B (cumulative)",
     "~$91,527 avg (stated, sub-$100k)", "No in-window milestone beyond the ongoing ramp toward the 2032 target", "2024-12 (original)",
     "https://www.ncbiotech.org/news/amgens-holly-springs-facilities-employ-more-700-2032", "Med"],
    [REPORT_DATE, "Clayton", "Johnston", "NC", "NEW — Novo Nordisk — manufacturing campus", "1,000", "$4.1B",
     "Estimated/Inferred $65k-$70k (sub-$100k; basis: company-disclosed range vs. ~$45k county avg)", "Construction phased 2027-2029; ~2,000 external contractors on-site for clearing/foundation work; no confirmed new 2026 milestone beyond ongoing construction", "2025 (original); ongoing construction",
     "https://businessnc.com/novo-nordisk-investing-4-1b-adding-1000-jobs-in-johnston-county/", "Med"],
    [REPORT_DATE, "Raleigh", "Wake", "NC", "NEW — BuildOps Inc. — 3rd US hub", "291", "$711,200",
     "$110,997 avg (stated; >$100k, but sub-500 jobs)", "Announced 2025-06-24, pre-window; no confirmed in-window milestone found", "2025-06-24",
     "https://www.commerce.nc.gov/news/press-releases/2025/06/24/governor-stein-announces-software-company-buildops-will-create-291-jobs-raleigh", "High"],
    [REPORT_DATE, "Statesville", "Iredell", "NC", "Compass Datacenters", "~250", "$1B+ (up to 500MW campus)",
     "Not disclosed", "Statesville rezoning for the ~340-acre, up to 500MW campus has been reported, but no precisely dated in-window 2026 milestone could be confirmed this cycle; operations still targeted 2028", "2025-08 (pre-window baseline)",
     "n/a", "Low-Med"],
    [REPORT_DATE, "Rowan County", "Rowan", "NC", "\"Project Rack\" (company undisclosed)", "258", "$41M",
     "Estimated/Inferred sub-$100k", "Rowan County Commissioners approved incentives 2026-06-06 (three-year tax incentives); Q1 2027 ops start still targeted", "2026-06-06",
     "https://www.salisburypost.com/2026/06/06/rowan-county-approves-project-rack-incentives-for-258-job-distribution-site/", "High"],
    [REPORT_DATE, "Rowan/Kannapolis", "Rowan", "NC", "Google (via 3rd-party logistics operator) — warehouse lease", "Not disclosed", "Not disclosed",
     "$55k-$150k range (job-board postings)", "Lease publicly confirmed 2026-04-29: 729,872 sq ft at Overlook 85 Industrial Park, 88-month term; explicitly described as 'not a data center' — warehousing/logistics; jobs still undisclosed", "2026-04-29",
     "https://www.wbtv.com/2026/04/29/google-leases-massive-facility-near-rowan-cabarrus-county-line/", "High (lease); Low (jobs)"],
    [REPORT_DATE, "York Co.", "York", "SC", "QTS \"Project Cobra\" — data-center campus", "~200 FTE (+~1,000 constr.)", "up to $8B",
     "~$80k median (stated)", "York County Council passed its 9-month data-center moratorium on 3rd/final reading 2026-07-13; QTS's own site plans (9 buildings, various stages) are already vested and unaffected by the moratorium", "2026-07-13",
     "https://www.wrhi.com/2026/06/york-county-council-approves-data-center-moratorium-first-reading-advances-1-5-billion-biopharmaceutical-project-213500", "High"],
    [REPORT_DATE, "Charlotte / SouthPark", "Mecklenburg", "NC", "JPMorgan Chase — new office", "400 new by 2028", "Not disclosed",
     "~$105k Estimated/Inferred", "No update found this cycle", "2026-04-21",
     "https://www.axios.com/local/charlotte/2026/04/21/jpmorgan-southpark-charlotte-400-jobs", "Med"],
    [REPORT_DATE, "Charlotte (CLT airport)", "Mecklenburg", "NC", "Averitt — logistics campus", "211", "$200M",
     "$81,769 (stated)", "No update found this cycle; construction 'expected to begin immediately' per original release, completion 2028", "2026-04-29",
     "https://www.axios.com/local/charlotte/2026/04/29/averitt-charlotte-douglas-airport-campus-jobs", "High"],
    [REPORT_DATE, "Mooresville", "Iredell", "NC", "NEW — Corvid Technologies — HQ expansion", "367", "$28.9M",
     "Not disclosed; Estimated/Inferred a meaningful share of engineering roles clear $100k (basis: Glassdoor role-level data — Software Engineer ~$134,243, Computational Analyst ~$138,353, Senior Program Manager ~$176,995; company-wide avg ~$77,578)", "Defense/aerospace/biomedical/motorsports physics engineering firm expanding its existing Mooresville HQ; announced 2026-06-20", "2026-06-20",
     "https://statesville.com/news/iredell-chosen-for-367-job-headquarters/article_e69950c5-7074-5f48-bbbc-a2c832f5bb1f.html", "Med-High"],
    [REPORT_DATE, "Spartanburg (former Kohler plant)", "Spartanburg", "SC", "NorthMark \"Project Moc-1\" — AI/HPC data center", "~150 FT at full operation", "$2.8B-$3.0B",
     "Not disclosed", "Contested public hearing held 2026-06-25; comment period closed 2026-07-31 with no permit decision yet issued (SCDES says review could take 'several months'); a new lawsuit was filed 2026-07-06 by local residents seeking Planning Commission review of the next construction phase; construction continues despite opposition", "2026-07-06 (lawsuit); 2026-07-31 (comment close)",
     "https://www.postandcourier.com/spartanburg/news/spartanburg-data-center-northmark-water-power/article_07cc2de8-9eb6-4711-ad7f-90ef8230b158.html", "High"],
    [REPORT_DATE, "Greenville", "Greenville", "SC", "GE Vernova — gas turbine mfg", "650 total planned (200 hired 2025; 300 more by end 2026)", "$160M (Greenville)",
     "Estimated/Inferred mixed, bulk likely sub-$100k (basis: job-board postings $66k-$125k)", "Hiring-ramp progress confirmed 2026-06-27 (200 hired 2025, 300 more targeted by end of 2026), consistent with production ramping from 37 turbines (2025) toward 74 (2027)", "2026-06-27",
     "https://www.cnbc.com/2026/06/27/ge-vernova-gas-turbines-ai-data-centers.html", "Med-High"],
    [REPORT_DATE, "Spartanburg / Roebuck", "Spartanburg", "SC", "Siemens Smart Infrastructure", "~150", "$165M",
     "Not disclosed", "No update found this cycle", "2026-03-18",
     "https://www.foxcarolina.com/2026/03/18/tech-manufacturer-building-expanding-upstate-facilities-creating-150-new-jobs/", "Med-High"],
    [REPORT_DATE, "Woodruff", "Spartanburg", "SC", "AIRSYS Cooling Technologies — global HQ", "215", "$40-60M",
     "Not disclosed", "Grand opening of the new 264,000 sq ft, 60-acre HQ campus confirmed 2026-05-13; manufacturing-operations start still targeted early 2027 (previously slipped from 2026, no further slip found)", "2026-05-13",
     "https://airsysnorthamerica.com/airsys-opens-global-headquarters-campus-in-south-carolina-to-meet-surging-global-demand-for-ai-and-data-center-cooling/", "High"],
    [REPORT_DATE, "Gray Court", "Laurens", "SC", "Aptiv Services US — Connexial Center", "277", "$120.8M",
     "Not disclosed", "No update found this cycle", "2026-04",
     "https://www.golaurens.com/news/laurens-county-welcomes-277-jobs-and-120-million-from-aptiv/article_a0c4713d-b677-40d3-b3a7-c68779533f7c.html", "High"],
    [REPORT_DATE, "Easley", "Anderson", "SC", "Signature Foods USA", "202", "$11.5M",
     "Estimated/Inferred sub-$50k", "Operations confirmed online; company still actively hiring", "2026-04",
     "https://www.postandcourier.com/greenville/business/easley-anderson-county-signature-foods-investment/article_1d618a58-af96-435a-a05c-7cc6f9253a83.html", "High"],
    [REPORT_DATE, "Greenville", "Greenville", "SC", "GNQ Insilico — AI/quantum techbio HQ", "Not disclosed", "$500M (valuation, not capex)",
     "Not disclosed", "Formal in-window relocation confirmation (HQ + labs moving from California/Canada to Greenville, initial lab ops at Clemson's CUBEInC) dated 2026-05-21/23; job projections still 'developing' pending planned public listing (SPAC merger)", "2026-05-21",
     "https://www.greenvillebusinessmag.com/stories/techbio-innovator-gnq-moves-north-american-headquarters-labs-to-greenville,43132", "Med"],
    [REPORT_DATE, "Greenville", "Greenville", "SC", "NEW — EnerSys — lithium-ion cell manufacturing (Augusta Grove)", "Originally 500 (2024); scope materially reduced", "~$500M (net, incl. ~$150M DOE grant)",
     "Not disclosed", "FLAG: 2026-07-23 scope revision cuts planned capacity ~75-80% (from ~4-5 GWh to ~1 GWh), refocused exclusively to aerospace/defense/specialized-industrial cells; construction now targeted 1H FY2028, full production ~2031 (a major slip from the original 2027 target). Original 500-job figure should be treated as stale pending a restated number", "2026-07-23",
     "https://investor.enersys.com/news/news-details/2026/EnerSys-Refines-Plans-for-DefenseFocused-Lithium-Cell-Manufacturing-Facility-with-DOE-Support/default.aspx", "Med-High (scope cut); Low (current jobs figure)"],
    [REPORT_DATE, "Fountain Inn", "Greenville", "SC", "NEW — EPC Power — AI data-center power inverter mfg", "275", "Not disclosed",
     "Estimated/Inferred sub-$100k (basis: job-board postings $47k-$64k/yr, $25-$35/hr)", "Grand opening/ribbon-cutting of the 167,000 sq ft facility (EPC Power's 3rd US site) held 2026-07-15", "2026-07-15",
     "https://www.foxcarolina.com/2026/07/15/epc-power-opens-facility-upstate-produce-critical-ai-data-center-technology/", "High"],
    [REPORT_DATE, "Orangeburg / I-26", "Orangeburg", "SC", "Ferrara Candy — new mfg + corporate site", "1,000 (10 yr)", "$675M",
     "Not disclosed; confectionery = workforce-tier", "No new milestone since the May 2026 groundbreaking; first lines still targeted Q1 2029", "2026-05-20",
     "https://www.wrdw.com/2026/05/20/ferrara-candy-company-breaks-ground-orangeburg/", "High"],
    [REPORT_DATE, "Berkeley / Dorchester", "Berkeley & Dorchester", "SC", "Google — data-center expansion", "~160 apprentices (FTE n/d)", "$9B",
     "Not disclosed", "No new in-window milestone found this cycle; $9B figure traces to an Oct. 2025 announcement (pre-window)", "2025-10-13",
     "https://blog.google/company-news/inside-google/company-announcements/google-american-innovation-south-carolina/", "High (capex)"],
    [REPORT_DATE, "North Charleston", "Charleston", "SC", "Boeing 787 — production-rate ramp", "1,000 (unchanged)", "$1.0B (existing)",
     "Estimated/Inferred mixed", "Rate confirmed 8/month as of Jan 2026; CEO targets 10/month by end of 2026; the $1B expansion is designed to eventually support 16/month by 2028, a more ambitious framing than the prior cycle's '10/month by 2027'", "2026-01-27",
     "https://scdailygazette.com/2026/01/27/boeing-looks-to-build-on-momentum-at-sc-dreamliner-plant/", "Med-High"],
    [REPORT_DATE, "North Charleston", "Charleston", "SC", "SC Ports Authority — Leatherman Terminal (OPERATIONS PAUSED)", "400 direct + ~1,200 indirect", "$1.2B (existing)",
     "Not disclosed", "CONFIRMED: SC Ports paused all container operations at Leatherman effective 2026-08-01 (today), consolidating cargo to Wando Welch/North Charleston, citing an 'uncertain trade outlook' and high labor costs from the all-union workforce structure (Leatherman handled <6% of SC Ports' container volume). No reopening date given; Phase 2 wharf construction ($88.5M) continues uninterrupted, targeted for 2027 completion. No confirmation found of ILA worker layoffs tied to the pause", "2026-06-25 (announced); 2026-08-01 (effective)",
     "https://scspa.com/news/sc-ports-consolidating-container-operations-in-the-short-term/", "High"],
    [REPORT_DATE, "Goose Creek", "Berkeley", "SC", "HII (Newport News Shipbuilding)", "~250 (estimate)", "Not disclosed",
     "Not disclosed", "One-year anniversary (Jan 2026) confirmed exceeding production targets; hosted Australia's Minister for Defence Industry 2026-07-27 in connection with the AUKUS submarine partnership — a positive diplomatic/business-development signal, but no new jobs/investment figures disclosed", "2026-07-27",
     "https://www.globenewswire.com/news-release/2026/07/27/3333932/0/en/hii-hosts-australian-minister-for-defence-industry-at-newport-news-shipbuilding-charleston-operations.html", "Med"],
]
...
WEEK4_EXCLUDED = [
    [REPORT_DATE, "Maersk North American HQ", "Charlotte", "NC", "520", "2025-11-18", "Pre-window; no new forward movement found beyond the previously-noted 1-year hiring delay (now 2027-2029); wage remains stated at $100,962 but a delay is not qualifying forward movement per report rules", "https://businessnc.com/maersk-delays-charlotte-headquarters-plan-hiring-520-workers-by-1-year/"],
    [REPORT_DATE, "Citigroup", "Charlotte / Ballantyne", "NC", "510", "2025-07-08", "Pre-window; the March 2026 grand-opening milestone remains tied to a pre-window (2025-07-08) commitment; no new increase or fresh milestone found this cycle", "https://hoodline.com/2026/03/stein-hits-ballantyne-as-citi-bets-big-on-charlotte-jobs/"],
    [REPORT_DATE, "Scout Motors HQ (Plaza Midwood)", "Charlotte", "NC", "1,200", "2025-11-12", "Pre-window; early job postings for the HQ (several six-figure roles) surfaced this cycle but do not amount to a formal milestone (lease signing, groundbreaking, or a announced hiring-ramp event) — recheck next cycle for a concrete trigger", "https://www.detroitnews.com/story/business/autos/2025/11/14/scout-motors-rolls-into-charlotte-5-key-things-about-the-automaker/87270881007/"],
    [REPORT_DATE, "PSA Airlines", "Charlotte (CLT)", "NC", "~400-450 (mix reloc.+new; ~250 net new)", "2026-03-19", "Grand opening reconfirmed (450+ team members, ~80% of net-new hiring filled); net-new local roles (~250) remain well below the 500-job threshold and wage remains mixed/mostly sub-$100k except for pilots — no new in-window update changes this assessment", "https://psaairlines.com/psa-airlines-celebrates-grand-opening-of-charlotte-headquarters-underscoring-economic-and-workforce-impact-across-north-carolina/"],
    [REPORT_DATE, "Bosch — Dorchester Co. electric motors", "Dorchester", "SC", "n/d (workforce 1,500->1,800)", "n/d", "No 2026 confirmation of resumption found this cycle; status remains unresolved/paused pending an EV-demand recovery", "https://www.postandcourier.com/business/bosch-dorchester-electric-vehicles-rivian-expansion/article_265b1c36-ab6c-11ef-b047-3b784368d210.html"],
    [REPORT_DATE, "Compass Datacenters", "Statesville (Iredell)", "NC", "~250", "2025-08", "No precisely-dated in-window 2026 milestone could be confirmed this cycle despite reported rezoning progress; staying excluded pending a hard date", "n/a"],
    [REPORT_DATE, "Snider Fleet Solutions (REMOVED)", "Indian Land (Lancaster)", "NC", "167", "2023-05", "REMOVED from tracking this cycle: confirmed stale for a third consecutive pass — all coverage traces to a May 2023 announcement with zero 2026 activity found", "https://www.qcnews.com/news/u-s/lancaster-county/major-manufacturing-company-moving-to-indian-land/"],
    [REPORT_DATE, "FN America — 2nd production facility (REMOVED)", "Liberty (Pickens)", "SC", "~176", "2023-04", "REMOVED from tracking this cycle: three consecutive quiet cycles with no 2026 news on hiring, production start, or facility completion found; all available coverage remains 2023-2024 era", "https://governor.sc.gov/news/2023-04/fn-america-llc-expanding-south-carolina-footprint-pickens-county-second-production"],
    [REPORT_DATE, "VinFast EV megafactory (Moncure megasite) — TERMINATED", "Chatham Co.", "NC", "Target cut from 7,500 to ~1,400; failed to meet 1,750-job threshold", "2026-07-28", "MAJOR REVERSAL: Chatham County Commissioners voted 2026-07-28 to terminate the $400M incentives agreement (site abandoned since late 2024, no construction contract, expired permits); NC AG separately sued (~2026-05-21) to force VinFast to sell back the land. A collapse, not a growth signal", "https://www.wral.com/business/vinfast-agreement-canceled-chatham-county-north-carolina-july-2026/"],
    [REPORT_DATE, "Wolfspeed — Durham fab (150mm device line)", "Durham", "NC", "N/A (shutdown)", "2026-02-04", "Closure of a legacy 150mm device-production line, completed ahead of schedule per Q2 FY26 earnings call — an explicit contraction, not a growth signal (Wolfspeed's Siler City project remains separately tracked in Watch)", "https://www.investing.com/news/transcripts/earnings-call-transcript-wolfspeeds-q2-2026-results-disappoint-stock-dips-93CH-4486298"],
    [REPORT_DATE, "TigerDC \"Project Spero\" (still withdrawn)", "Spartanburg Co.", "SC", "~50 FTE (Phase I)", "2026-02-27", "Confirmed still withdrawn this cycle; no revival evidence found", "https://www.foxcarolina.com/2026/02/27/company-withdraws-ai-data-center-spartanburg-county-consideration/"],
    [REPORT_DATE, "Corvid Technologies (retained note)", "Mooresville (Iredell)", "NC", "367", "2026-06-20", "Tracked in Watch tier this cycle (367 jobs, wage not officially stated) — noted here only to confirm it does NOT qualify for Ranked: sub-500 jobs", "https://statesville.com/news/iredell-chosen-for-367-job-headquarters/article_e69950c5-7074-5f48-bbbc-a2c832f5bb1f.html"],
    [REPORT_DATE, "Numerous sub-200-job items (Poly-America/Carolina Poly Chester, Element Designs Fort Mill, TTX Charlotte, RXO Ballantyne, Daimler Truck Financial Ballantyne, Red Bull/Rauch Concord, EG Group Charlotte [jobs undisclosed], Lowe's Mooresville [-600, layoffs])", "Various Charlotte metro", "NC/SC", "12-450 each (or layoffs)", "2021-2026", "Below Watch floor, low-wage, recycled old news with no in-window update, or (Lowe's) a layoff rather than a growth signal", "n/a"],
    [REPORT_DATE, "Numerous sub-200/recycled items (Corning/Meta Hickory [out of region], Skyeton Fayetteville [out of region], CorestemChemon Winston-Salem [vague], Herbalife Winston-Salem, GMAX Industries, Foster Caviness/ReAgent/Tex-Tech Winston-Salem, Wilmington Trade Center Phase 2 [speculative/unallocated], Honda Aircraft Greensboro, Hoffman & Hoffman Greensboro, ImpactData Greensboro, Southeastern Container Enka-Candler)", "Various Triad/WNC/Coastal", "NC", "12-1,500 each", "2019-2026", "Below Watch floor, out of region, vague/speculative, or recycled old news with no in-window update", "n/a"],
    [REPORT_DATE, "Numerous sub-200/recycled items (Cisco RTP \"550 jobs\" [stale SEO content, actually 2014], Merck Durham \"180 jobs\" [~2011], Microsoft Wake \"500 jobs\" [2019], CITEL America Hillsborough, Innovative Construction Group Chatham, Ypsomed Holly Springs, Audemars Piguet Raleigh, Fujifilm RTP, AdvanceTEC Johnston [160 jobs/~$90k])", "Various NC Triangle", "NC", "62-550 each", "2011-2026 (mostly stale)", "Below Watch floor and/or recycled/stale old news falsely resurfacing in current searches; no in-window update", "n/a"],
    [REPORT_DATE, "Numerous sub-200-job items (Cielo Digital Infrastructure Cherokee [30 jobs/$2.1B], Oshkosh Defense Spartanburg [recycled 2021], Detpak USA Spartanburg, Fortified Solar Greenville, United Composite Materials Greenville, Advanced Metalworks Anderson, Southern Wall Products Anderson, Sargent Metal Fabricators Anderson, Eastern Engineered Wood Anderson, Sync.MD Anderson, Woodward Inc. Greer [~275 jobs, no in-window milestone])", "Various Upstate SC", "SC", "10-1,000 each", "2021-2026", "Below Watch floor regardless of window, capex-heavy with tiny headcount, or recycled old news with no in-window update", "n/a"],
    [REPORT_DATE, "Numerous sub-200/incomplete items (AVANTech Richland, Mattress Warehouse Lexington, Hoffman & Hoffman Lexington, Patten Seed Charleston, ZEB Metals Berkeley, Summerville warehouse Dorchester, TS Conductor Jasper [out of region], Delta Children's Orangeburg, ALLTAPE Adhesive Lexington [no figures], Southern Glazer's Wine & Spirits Lexington [job count not found before search budget exhausted])", "Various Midlands/Lowcountry", "SC", "12-462 each (or undisclosed)", "2022-2026", "Below Watch floor, out of region, or insufficient data (no job/wage figures located) to assess against thresholds — flagged for a follow-up search next cycle where noted", "n/a"],
]
...
WEEK4_SCORE_DETAIL = [
    [REPORT_DATE, "SMBC Group (Charlotte)", 93, "Unchanged; no new milestone this cycle."],
    [REPORT_DATE, "Octapharma (Rock Hill)", 90, "Rock Hill City Council voted unanimously 7-0 (2026-07-23) to approve the land sale and amended tax-incentive agreement, closing out the prior cycle's single outstanding risk (the city-level vote). Deal is now fully cleared on both county and city sides; +3 for removed execution-risk discount."],
    [REPORT_DATE, "Scout Motors (Blythewood)", 85, "Hiring event proceeded on schedule (positive) but the customer-delivery timeline slip to 'early 2028' is now stated explicitly rather than softly implied; net -1 for confirmed further timeline risk."],
    [REPORT_DATE, "AbbVie (Durham)", 84, "Unchanged; no new milestone this cycle."],
    [REPORT_DATE, "Capital Group (Charlotte)", 81, "Unchanged; no new milestone this cycle."],
    [REPORT_DATE, "Genentech (Holly Springs)", 80, "Unchanged; no new milestone this cycle."],
    [REPORT_DATE, "JetZero (Greensboro)", 80, "EXIM Bank Letter of Interest (2026-07-20) to explore up to $3B in financing strengthens capital/project-certainty even though no new jobs/wage figures moved; +1."],
    [REPORT_DATE, "Novartis (Durham/Morrisville)", 77, "Unchanged; no new milestone this cycle."],
]
...
SUMMARY_LINES = [
    ...
    ("Top mover", "Rock Hill / York Co. (SC) — Octapharma 'Project Palmetto Rock', score 90 (+3) — Rock Hill City Council voted unanimously 7-0 on 2026-07-23 to approve the land sale and amended tax-incentive terms, closing out the deal on both county and city sides"),
    ("Key takeaway", "No brand-new qualifying (500+ job / $100k+ wage) deal was found in any of the five sub-regions this cycle — all 8 ranked entries carry forward. Octapharma's Rock Hill City Council vote (unanimous, 7-0) resolves the prior cycle's biggest open risk. Two major reversals surfaced: SC Ports' Leatherman Terminal pause took effect as scheduled on Aug. 1, 2026, and Chatham County terminated its VinFast EV-megafactory incentive agreement (7,500-job target collapsed to ~1,400, then cancelled outright) on July 28, 2026. Aspida Financial Services (Durham, 1,000 jobs, $137,288 stated wage) is a strong near-miss on Watch pending an in-window milestone."),
    ("Window note", "Trailing 6 months now runs 2026-02-03 to 2026-08-03."),
    ("Data-quality note", "Maersk (Charlotte, wage stated at $100,962) and Citigroup (Ballantyne, wage stated at $131,832) remain excluded for a second/third consecutive cycle for consistency with this dataset's established milestone rules — both clear job-count/wage thresholds but their only in-window 'movement' traces to a hiring delay or a pre-window commitment, not genuine forward progress."),
    ("Week-over-week", "8 of 8 prior-ranked deals remain qualifying (none removed, none newly added); 2 gaining momentum (Octapharma, JetZero), 1 updated (Scout Motors, timeline slip confirmed), 5 repeated (SMBC, AbbVie, Capital Group, Genentech, Novartis). Watch tier: 2 removed as stale (Snider Fleet Solutions, FN America), ~10 new additions (incl. Aspida Financial Services, Lenovo Whitsett, EnerSys Greenville scope-cut, Ahold Delhaize/Food Lion Burlington)."),
]

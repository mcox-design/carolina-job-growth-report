...
WINDOW = "2026-01-20 to 2026-07-20"  # trailing 6 months
...
# ---- Week 4 (2026-07-20) ----
WEEK4_RUNNING = [
    [REPORT_DATE, "Repeated", 1, 93, "Charlotte / Uptown", "Mecklenburg", "NC", "SMBC Group — 2nd US HQ / bank operations", "Banking / financial services", "Lease signed / active hiring milestone (unchanged)", 2000, "Projected (6 yr)", "$165,316 avg (stated; vs county $90,706)", "N/A — stated", "$50.5M", "JDIG up to $70.0M / 12 yr; $23.3M IDF-Utility Account", "Leased former One Wells Fargo Center; hiring 70+ roles; first workers fall 2026", "2026-05-04", "https://www.axios.com/local/charlotte/2026/05/04/smbc-headquarters-wells-fargo-center-uptown", "High", "Office / HQ banking", "Urban", "Premier high-income signal; Class-A urban MF + high-end for-sale TH in Uptown/South End/Dilworth.", "No new in-window milestone found this cycle (second consecutive quiet cycle); project remains on track for fall 2026 first arrivals."],
    [REPORT_DATE, "Gaining Momentum", 2, 88, "Rock Hill / York Co.", "York", "SC", "Octapharma — \"Project Palmetto Rock\" HQ + manufacturing campus", "Biopharmaceutical (plasma fractionation)", "Rock Hill School Board endorsement of amended tax-share terms; City Council vote still outstanding", 1500, "Projected (1,200 new + 300 relocated)", "$141,502 avg HQ / $102,752 avg mfg (both stated, county-presented figures)", "N/A — stated", "$1.5B", "Fee-in-lieu-of-tax, assessment ratio cut to 4%; ~85% of Rock Hill's tax share redirected mostly to Rock Hill Schools", "York County Council 3rd reading approved 2026-07-08 (4-3); Rock Hill School Board voted 5-2 on 2026-07-13 to back the amended tax-share structure and urge City Council to accept it; Rock Hill City Council has still not voted as of 2026-07-20 (unconfirmed reporting points to an Aug. 10, 2026 council agenda — not independently verified)", "2026-07-13", "https://www.fortmillsun.com/2026/07/13/rock-hill-schools-board-urges-city-to-accept-county-tax-allocations/", "High (facts); Med (deal certainty)", "Office/HQ + biopharma mfg", "Suburban", "Dual-tier: $141k HQ roles -> luxury for-sale/Class-A in Rock Hill/Fort Mill; $102k mfg roles -> premium workforce-plus rental/TH.", "School board's 5-2 endorsement removes one point of local opposition, but Rock Hill City Council's outstanding vote on the amended tax-share terms remains the key unresolved risk; +1 for continued forward momentum with no new negative signal this cycle."],
    [REPORT_DATE, "Repeated", 3, 86, "Blythewood / N. Columbia", "Richland", "SC", "Scout Motors — EV assembly plant (active hiring ramp)", "Automotive / EV manufacturing", "Hiring event announced; companywide headcount update", 4000, "Projected (~1,400 hired companywide; 600+ in SC)", "$30-$37.50/hr line (stated; senior maintenance techs to $37.50/hr); salaried higher", "Estimated/Inferred mix supports above-median HH income", "$2.0B (+$25M training center)", "State/local package (2023); $25M readySC", "Companywide headcount holds at ~1,400 (~600 in SC), confirmed via WLTX and Scout's own blog as of mid-July 2026; production still targeted late 2027, customer deliveries trending 2028", "2026-07", "https://www.wltx.com/article/news/local/midlands/building-the-midlands/scout-motors-plant-blythewood-update/101-c64d17ed-4b85-4fae-b866-e7e1a08021f1", "High", "Auto mfg + salaried eng.", "Suburban", "Bifurcated: salaried/professional -> higher-income for-sale & Class-A; hourly base -> workforce/missing-middle rental in N. Richland/Fairfield.", "CORRECTION: last week's report cited a 2026-07-29 pre-hire event for 70+ maintenance techs; this cycle's research found the wage/role details trace precisely to a 2025-07-10 WISTV story and a 2025-07-25 SC Daily Gazette story, with no distinctly-dated 2026 version found — that specific claim is now treated as unverified/likely a dating error and is not carried forward. Headcount and the active-hiring trend remain independently confirmed."],
    [REPORT_DATE, "Updated", 4, 84, "Durham / RTP", "Durham", "NC", "AbbVie — biopharma manufacturing campus", "Biopharma / life sciences mfg", "County incentive hearing (procedural step, no scale change)", 734, "Projected (+2,000 construction)", "$118,041 avg (stated; vs county $102,817)", "N/A — stated", "$1.4B", "JDIG up to $19.3M / 12 yr; $6.4M IDF-Utility; +city/county", "Durham County Board of Commissioners held a public hearing 2026-07-13 on a proposed $15M county incentive package (on top of the ~$26M state EIC incentive approved in April); no vote outcome reported yet", "2026-07-13", "https://abc11.com/post/abbvie-pharmaceutical-project-moves-forward-durham/19500900/", "High", "Adv. mfg / R&D / lab", "Suburban-urban", "High-end MF + move-up for-sale around Durham/RTP; spillover Wake/Orange. Construction-phase rental near-term.", "Procedural incentive step, not a scale change; construction start still targeted this year."],
    [REPORT_DATE, "Repeated", 5, 81, "Charlotte", "Mecklenburg", "NC", "Capital Group — East Coast operations hub", "Investment mgmt / finance + tech", "Wage figure confirmed (stated, not inferred)", 600, "Projected", "$194,141 avg (stated; NC Commerce JDIG figure)", "N/A — now stated (was Estimated/Inferred ~$190k)", "$60M", "JDIG up to $17.2M / 12 yr; $5.7M IDF-Utility", "12-yr JDIG term; lease term began 2026-05-22", "2026-05-26", "https://crenews.com/2026/05/28/capital-group-leases-200000-sf-at-charlottes-one-independence-center-office/", "High", "Office — finance/tech", "Urban-suburban", "High-skill eng/data workforce -> walkable South End/Uptown & inner-suburban Class-A and for-sale TH.", "No new in-window milestone found this cycle."],
    [REPORT_DATE, "Repeated", 6, 80, "Holly Springs / SW Wake", "Wake", "NC", "Genentech — biomanufacturing expansion", "Adv. biomanufacturing", "Expansion of committed project", 500, "Projected (site total)", "~$119,833 avg (stated, 2025 tranche)", "N/A — stated", "~$2.0B", "JDIG up to $9.85M / 12 yr (original 420-job award)", "Operational by 2029", "2026-01-20", "https://www.gene.com/media/press-releases/15096/2026-01-20/genentech-more-than-doubles-investment-i", "High", "Adv. biomanufacturing", "Suburban", "Strong higher-income for-sale + Class-A rental in fast-growing SW Wake.", "No new in-window milestone found this cycle; the sole dated milestone (2026-01-20 investment doubling) sits exactly at this week's window boundary (2026-01-20 to 2026-07-20) — still inclusive, but flagged as at risk of aging out of the window next cycle absent a new update."],
    [REPORT_DATE, "Updated", 7, 80, "Greensboro / PTI Airport", "Guilford", "NC", "JetZero — aerospace plant (groundbreaking held; hiring pushed further)", "Aerospace / advanced manufacturing", "Groundbreaking ceremony + JDIG base-period amendment", 14500, "Projected", "$89,340 avg (stated, 2025)", "N/A — stated (2025)", "$4.7B", "Transformative JDIG up to $1.018B / 37 yr; Guilford grant $75.9M / 20 yr; base period shifted to 2028-2037", "Groundbreaking held 2026-06-15; zero jobs still projected for 2027; hiring ramp begins 2028-2029 (3,020 jobs by end 2029); full 14,500+ target due by 2037; Governor Stein signed the FY2026-27 state budget on 2026-07-07, releasing the previously-frozen $133.9M JDIG-linked infrastructure allocation (on top of $118.1M already allotted) — company communications called it 'all systems go'", "2026-07-07", "https://www.carolinajournal.com/state-budget-allocates-133-9m-for-delayed-jetzero-project/", "High (facts); Low (timeline)", "Aerospace mfg + eng.", "Suburban", "Same long-run scale, but full-target timeline has slipped a further year (2036->2037); construction is real and tangible even as hiring pushes out.", "+1 for confirmed release of state incentive funding (an execution-certainty signal), though the hiring-ramp timeline itself is unchanged from last cycle."],
    [REPORT_DATE, "Repeated", 8, 77, "Durham / Morrisville", "Durham & Wake", "NC", "Novartis — API mfg building (investment increase)", "Adv. mfg / API production", "New facility (unchanged)", 700, "Projected (part of pre-window deal)", "$111,161 avg (stated)", "N/A — stated", "~$991M (incl. $220M API building)", "Part of original $771M package incentives", "Facility opening targeted 2027-2028", "2026-04-30", "https://www.wral.com/news/local/novartis-pharmaceuticals-expands-nc-presence-morrisville-plant-april-2026/", "High", "Adv. mfg / API production", "Suburban", "Reinforces sustained high-wage biomanufacturing hiring in Wake/Durham corridor.", "No new in-window milestone found this cycle."],
]
...
# ---- Week 4 (2026-07-20) ----
WEEK4_WATCH = [
    [REPORT_DATE, "Cherokee Co. / Blacksburg", "Cherokee", "SC", "USA Rare Earth — rare-earth magnet plant", "~490", "$1.2B", "$24.50-$63/hr (stated; unchanged)", "Still just under 500 jobs; no threshold-crossing update found this cycle (high-priority check)", "2026-06-02", "https://www.postandcourier.com/spartanburg/business/usa-rare-earth-blacksburg-sc-facility/article_2681ca76-7e5f-4a73-8a80-13231e38917f.html", "High"],
    [REPORT_DATE, "Orangeburg / I-26", "Orangeburg", "SC", "Ferrara Candy — groundbreaking held", "1,000 (10 yr)", "$675M", "Not disclosed; confectionery = workforce-tier", "No new milestone since May 2026 groundbreaking; first lines targeted Q1 2029", "2026-05-20", "https://www.wrdw.com/2026/05/20/ferrara-candy-company-breaks-ground-orangeburg/", "High"],
    [REPORT_DATE, "Laurens Co.", "Laurens", "SC", "Suniva — solar-cell plant", "564", "$350M", "Stated $23-$53/hr = workforce-tier", "No update found this cycle; operations targeted spring/summer 2027", "2026-04-14", "https://www.postandcourier.com/greenville/business/suniva-solar-cell-plant-laurens-sc/article_986c2fc2-2335-48cb-bd3c-92e89604c49c.html", "High"],
    [REPORT_DATE, "Columbia / BullStreet", "Richland", "SC", "AMAROK — new HQ (perimeter security)", "296", "$69M", "Not disclosed; HQ/professional (portion likely $100k+)", "No update found this cycle", "2026-03-03", "https://www.postandcourier.com/columbia/business/columbia-sc-bullstreet-amarok-headquarters/article_73ea5904-fe8c-4048-b0a3-10417d1af35e.html", "High"],
    [REPORT_DATE, "Greensboro", "Guilford", "NC", "Lumentum — AI/data-center optics", "~400", "Hundreds of millions", "Not disclosed", "Ribbon-cutting/opening ceremony held late April 2026 for the 240,000 sq ft facility; production ramp still targeted mid-2028", "2026-04", "https://myfox8.com/news/north-carolina/greensboro/lumentum-holdings-opens-new-manufacturing-facility-in-greensboro/", "High"],
    [REPORT_DATE, "Hendersonville", "Henderson", "NC", "BorgWarner — vertical-integration expansion", "378", "$100M", "$67,047 avg (stated; below $100k)", "Now corroborated via official NC Commerce/Governor press releases dated 2026-05-26, resolving prior cycle's uncorroborated flag", "2026-05-26", "https://www.commerce.nc.gov/news/press-releases/2026/05/26/governor-stein-announces-100-million-expansion-borgwarner-hendersonville", "High"],
    [REPORT_DATE, "Asheville / Arden", "Buncombe", "NC", "Eaton — Low Voltage Assembly expansion", "300", "Not disclosed", "'high-tech, high-wage' but figure Not disclosed (Inferred mid-$60k-$80k)", "Eaton recruiting at WNC Career Expo 2026-04-16; confirmed as 7th Helene-recovery manufacturer expansion", "2026-04-08", "https://www.ashevillechamber.org/news-events/press-releases/eaton-invests-in-workforce-growth-in-buncombe-county/", "High (jobs); Low (wage)"],
    [REPORT_DATE, "Charlotte / Raleigh / Rural Hall", "Multi", "NC", "Siemens Energy — $421M NC expansion", "500 (statewide)", "$421M", "Not disclosed (Inferred ~$87k from prior tranche; sub-$100k)", "No update found this cycle; Mecklenburg-specific allocation for this tranche remains unclear (conflated with a 2024 tranche in some coverage)", "2026-02-04", "https://businessnc.com/siemens-energys-421-million-n-c-expansion-adding-500-jobs/", "Med (totals uncertain)"],
    [REPORT_DATE, "Raleigh / Wendell / Knightdale", "Wake", "NC", "Siemens AG — power devices for AI/data centers", "350", "part of $165M", "Not disclosed", "New 101,000 sq ft Wendell facility coming online July 2026; Knightdale targeting 100 jobs by end 2026; expanded Wendell campus (+200 jobs) by 2028", "2026-03-17", "https://www.wral.com/business/siemens-350-jobs-nc-sc-165m-investment-ai-data-centers-raleigh-wendell-march-2026/", "High"],
    [REPORT_DATE, "Kernersville", "Forsyth", "NC", "John Deere — excavator plant (relocating from Japan)", "150+", "$70M", "Not disclosed (Inferred skilled-mfg)", "Reaffirmed 2026-01-28 via White House-linked event; construction underway on west campus, facility slated to open within the next year", "2026-01-28", "https://greensboro.com/news/local/business/development/article_f8077494-ba1d-526b-a82a-9d8425f0acbe.html", "High"],
    [REPORT_DATE, "York Co.", "York", "SC", "QTS \"Project Cobra\" — data-center campus", "~200 FTE (+~1,000 constr.)", "up to $8B", "~$80k median (stated)", "York County's nine-month data-center moratorium received FINAL passage 2026-07-14 (6-0); it bars new site plans/special exceptions/CUPs for data centers in unincorporated York Co. through ~April 2027 but explicitly exempts projects with vested rights — QTS's under-construction buildings are understood to be unaffected", "2026-07-14", "https://www.wrhi.com/2026/07/york-county-council-approves-nine-month-data-center-moratorium-214184", "High"],
    [REPORT_DATE, "Berkeley / Dorchester", "Berkeley & Dorchester", "SC", "Google — data-center expansion", "~160 apprentices (FTE n/d)", "$9B", "Not disclosed", "No new in-window milestone found this cycle; original Oct. 2025 announcement remains the latest news", "2025-10-13", "https://blog.google/company-news/inside-google/company-announcements/google-american-innovation-south-carolina/", "High (capex)"],
    [REPORT_DATE, "Spartanburg", "Spartanburg", "SC", "Siemens Smart Infrastructure", "~150", "$165M", "Not disclosed", "No update found this cycle", "2026-03-18", "https://www.foxcarolina.com/2026/03/18/tech-manufacturer-building-expanding-upstate-facilities-creating-150-new-jobs/", "Med-High"],
    [REPORT_DATE, "Hamlet", "Richmond", "NC", "AWS/Amazon — AI/cloud campus", "500", "$10B", "Not disclosed", "Still unverified; outside this cycle's five assigned research regions — needs direct confirmation next cycle", "verify", "https://www.aboutamazon.com/", "Low (needs verification)"],
    [REPORT_DATE, "Wake Co. (aggregate)", "Wake", "NC", "County jobs pipeline (EDGE 7, 52 projects)", "~11,000 (pipeline)", "$11B", "Mixed (office-skewed)", "RECONCILED this cycle: the previously-flagged second figure (~30 projects/8,000-10,800 jobs/$5.6B) is confirmed to be the closed, prior EDGE 6 campaign (concluded ~Sept 2024) — sequential, not duplicative, with the current $11B/11,000-job EDGE 7 pipeline", "2026-02", "https://nchospitalityalliance.com/wake-county-pursues-11-billion-jobs-pipeline/", "Med"],
    [REPORT_DATE, "Charlotte / SouthPark", "Mecklenburg", "NC", "JPMorgan Chase — new office (1,000-employee bldg)", "400 new by 2028", "Not disclosed", "~$105k Estimated/Inferred (job-posting range)", "No update found this cycle", "2026-04-21", "https://www.axios.com/local/charlotte/2026/04/21/jpmorgan-southpark-charlotte-400-jobs", "Med-High"],
    [REPORT_DATE, "Charlotte (CLT airport)", "Mecklenburg", "NC", "Averitt — logistics campus", "211", "$200M", "$81,769 avg (stated)", "No update found this cycle", "2026-04-29", "https://www.axios.com/local/charlotte/2026/04/29/averitt-charlotte-douglas-airport-campus-jobs", "High"],
    [REPORT_DATE, "Rowan County", "Rowan", "NC", "American Eagle Outfitters Inc. — \"Project Rack\" distribution hub (identity confirmed)", "200+ (per 2026-07-17 announcement; county incentive filing cited 258)", "$41M", "$57,351 avg for ~70 skilled roles (stated); bulk of the 200+ workforce likely lower (Estimated/Inferred)", "Company identity confirmed 2026-07-17: American Eagle Outfitters Inc., $41M, 472,890 sq ft distribution hub at Innovation Logistics Center, 1415 Peeler Road, Salisbury; Q1 2027 ops start unchanged", "2026-07-17", "https://governor.nc.gov/news/press-releases/2026/07/17/governor-stein-announces-american-eagle-outfitters-inc-selects-rowan-county-41-million-southeast", "High"],
    [REPORT_DATE, "Rowan / Kannapolis", "Rowan", "NC", "Google (via DHL) — 730k sq ft warehouse lease", "Not disclosed", "Not disclosed", "$55k-$150k range (DHL postings)", "No update found this cycle; jobs still undisclosed", "2026-04-29", "https://www.salisburypost.com/2026/05/02/not-a-data-center-google-leases-rowan-county-side-kannapolis-industrial-site/", "Med"],
    [REPORT_DATE, "Raleigh / North Hills", "Wake", "NC", "Ralliant Corp. — global HQ launch", "180", "$2.1M", "$170k-$189k avg (stated)", "No update found this cycle", "2026-03", "https://www.wral.com/business/technology/ralliant-launches-raleigh-global-hq-north-hills-march-2026/", "High"],
    [REPORT_DATE, "Siler City", "Chatham", "NC", "Wolfspeed — silicon-carbide fab", "1,800 (proj.)", "$5.0B", "$77,753 avg (stated)", "Post-bankruptcy ramp described by the company as 'more measured/disciplined' — original full-occupancy March 2026 target appears to have slipped; SiC crystal growth/wafer shipments to Mohawk Valley (NY) underway", "2026-Q1 (10-Q)", "https://www.sec.gov/Archives/edgar/data/0000895419/000089541926000030/wolf-20260329.htm", "Med (financial distress clouds trajectory)"],
    [REPORT_DATE, "Benson", "Johnston", "NC", "Vulcan Elements — magnet factory", "1,000 (proj.)", "$918.4M", "$81,932 avg (stated)", "'Hundreds of workers already on site' per current coverage; JCC training cohorts begin summer 2026 as originally scheduled", "2026-summer (training start)", "https://www.wral.com/sponsored/fifth-third-bank/the-next-industrial-revolution-how-vulcan-elements-makes-nc-the-backbone-of-vital-global-market/", "Med"],
    [REPORT_DATE, "Wake County (statewide)", "Wake", "NC", "WakeMed / Atrium Health — proposed merger", "3,300 (statewide, 5 yr)", "$2.0B (Wake Co. portion)", "Not disclosed", "Vote still not scheduled as of 2026-07-20; the 90-day delay from 2026-05-04 points to early August 2026; opposition continues (Brown University School of Public Health cost-impact report, community groups)", "2026-05-04 (delay announced)", "https://www.wral.com/news/local/wakemed-atrium-merger-costs-opposition-july-2026/", "Med"],
    [REPORT_DATE, "Greensboro / PTI Airport", "Guilford", "NC", "Boom Supersonic — Overture assembly (AT RISK)", "<=500 currently; must hit 500 by 12/31/26 or lease may terminate", "~$50M (hangar, existing)", "Not disclosed", "No positive or negative movement found this cycle; hangar still largely idle, and the Dec. 31, 2026 500-employee deadline is now roughly five months away with no confirmed hiring progress", "2026-07", "https://www.prismnews.com/local/guilford-nc/boom-supersonics-greensboro-factory-sits-idle-as-state", "High (risk)"],
    [REPORT_DATE, "Multi-site NC incl. Wilmington", "New Hanover +", "NC", "Amazon-Corning — fiber-optics partnership", "1,000 (multi-site, unallocated)", "Multi-billion (undisclosed NC-specific)", "Avg salary >$65,000 (newly disclosed; sub-$100k)", "Wage now disclosed (exceeds $65k) but still sub-$100k; per-site (incl. Wilmington-specific) job allocation still not broken out", "2026-06-08", "https://www.corning.com/worldwide/en/about-us/news-events/news-releases/2026/06/amazon-announces-agreement-with-corning-to-boost-us-fiber-optics-manufacturing-creating-1000-advanced-manufacturing-jobs-in-north-carolina.html", "Med"],
    [REPORT_DATE, "Arden", "Buncombe", "NC", "Pratt & Whitney (RTX) — casting foundry expansion", "325", "$285M", "$62,413 avg (stated)", "On track: first equipment arrival end of 2026, first parts production mid-2027, hiring ramp begins mid-2027", "2026 (equipment arrival timeline)", "https://www.flightglobal.com/engines/2026/04/rtx-says-gtf-groundings-are-coming-down-thanks-to-maintenance-ramp/", "Med-High"],
    [REPORT_DATE, "Asheboro", "Randolph", "NC", "Environmental Air Systems", "300", "$20M", "$55,133 avg (stated)", "No update found this cycle despite targeted searches", "2025-11-25 (orig.)", "https://businessnc.com/randolph-county-wins-20-million-hvac-project-300-jobs/", "Med"],
    [REPORT_DATE, "Wilmington", "New Hanover", "NC", "GE Hitachi / Global Nuclear Fuel — GNF4 fuel line", "Not disclosed", "Not itemized", "Not disclosed", "GNF4 fuel fabrication began early 2026; lead-use assemblies scheduled for deployment in commercial reactors during 2026 — genuine in-window production milestones, jobs still undisclosed", "2026 (fabrication start)", "https://www.world-nuclear-news.org/articles/global-nuclear-fuel-unveils-new-gnf4-product", "Med"],
    [REPORT_DATE, "Woodruff / Spartanburg Co.", "Spartanburg", "SC", "AIRSYS Cooling Technologies — global HQ", "215", "$40-60M", "Not disclosed (Estimated/Mixed)", "Manufacturing-operations start slipped from 2026 to early 2027; HQ campus itself already opened", "~2026 (HQ opening); early 2027 (mfg slip)", "https://www.postandcourier.com/spartanburg/business/airsys-data-center-water-woodruff-sc/article_86465e32-7d21-4bba-9a9b-3e6ea0e2d691.html", "Medium"],
    [REPORT_DATE, "Gray Court", "Laurens", "SC", "Aptiv Services US — Connexial Center", "277", "$120.8M", "Not disclosed", "No update found this cycle", "2026-04-20", "https://www.golaurens.com/news/laurens-county-welcomes-277-jobs-and-120-million-from-aptiv/article_a0c4713d-b677-40d3-b3a7-c68779533f7c.html", "High"],
    [REPORT_DATE, "Easley (Anderson/Pickens border)", "Anderson", "SC", "Signature Foods USA", "202", "$11.5M", "Estimated/Inferred sub-$50k (food mfg.)", "Operations confirmed online as of April 2026", "2026-04", "https://www.postandcourier.com/greenville/business/easley-anderson-county-signature-foods-investment/article_1d618a58-af96-435a-a05c-7cc6f9253a83.html", "High"],
    [REPORT_DATE, "Greenville", "Greenville", "SC", "GNQ Insilico — AI/quantum techbio HQ", "Not disclosed", "$500M (valuation, not capex)", "Not disclosed", "No update on headcount found this cycle", "2026-05", "https://www.greenvillebusinessmag.com/stories/techbio-innovator-gnq-moves-north-american-headquarters-labs-to-greenville,43132", "Med"],
    [REPORT_DATE, "North Charleston", "Charleston", "SC", "Boeing 787 — production-rate ramp", "1,000 (unchanged)", "$1.0B (existing)", "Estimated/Inferred mixed ($54-64k assemblers; eng. likely higher)", "Rate confirmed holding steady at 8/month as of the Farnborough Airshow (mid-July 2026); 10/month target reaffirmed 'over the next year' — consistent with, not accelerating beyond, prior framing", "2026-07-16", "https://leehamnews.com/2026/07/16/bca-riding-recovery-momentum-into-farnborough-air-show/", "Med-High"],
    [REPORT_DATE, "North Charleston", "Charleston", "SC", "SC Ports Authority — Leatherman Terminal Phase 2 (OPERATIONS PAUSED)", "400 direct + ~1,200 indirect (unchanged projection)", "$1.2B (terminal, existing)", "Not disclosed (Estimated mixed, some 6-figure specialist roles)", "No reversal found; pause remains on track for Aug. 1, 2026 start (~5% of container volume / 5 weekly MSC calls affected); cargo shifting to Wando Welch/North Charleston terminals; no operations-resumption timeline given", "2026-06-25", "https://scdailygazette.com/2026/06/25/sc-ports-temporarily-halts-leatherman-operations-in-face-of-high-costs-waning-demand/", "High (risk)"],
    [REPORT_DATE, "Goose Creek", "Berkeley", "SC", "HII (Newport News Shipbuilding) — 1-yr anniversary", "~250 (estimate, not re-confirmed)", "Not disclosed", "Not disclosed", "One-year operations anniversary reached 2026-01-22; company reports exceeding production targets, but no updated job-count figure surfaced", "2026-01-22", "https://www.live5news.com/2026/01/22/defense-provider-celebrates-one-year-operations-lowcountry/", "Med"],
    [REPORT_DATE, "Liberty", "Randolph", "NC", "Toyota Battery Manufacturing NC (TBMNC) — EV/hybrid battery megaplant", "5,100 (proj. total); 3,000+ now employed", "$13.9B", "$62,234 avg (stated; below $100k)", "NEW to Watch: employment crossed 3,000+ workers (Feb 2026 milestone); all-EV battery line targeted to launch later 2026, plug-in hybrid line mid-2027; scale of hiring velocity in a rural county may pressure workforce housing despite sub-$100k wage", "2026-02", "https://www.wfmynews2.com/article/news/local/major-milestone-over-3000-people-now-work-at-the-toyota-battery-plant/83-b192b700-91b7-42f4-837e-33d0c01ee96e", "Med-High"],
    [REPORT_DATE, "Spartanburg (former Kohler plant)", "Spartanburg", "SC", "NorthMark Strategies \"Project Moc-1\" — AI/HPC data center", "~150 FT at full operation (revised up from ~27); 400-600 temporary construction", "$2.8B", "Not disclosed", "SCDES air-permit comment period remains open through 2026-07-31; residents and the SC Environmental Law Center filed a lawsuit challenging the county's 'minor development' approval (hearing scheduled 2026-07-30 in Columbia); Spartanburg County Council separately gave first-reading approval to a one-year moratorium on new data-center proposals", "2026-07-08", "https://www.foxcarolina.com/2026/07/08/lawsuit-targets-spartanburg-county-data-center-project-demands-public-planning-review/", "Med (contested/evolving; litigation adds new risk)"],
    [REPORT_DATE, "Greenville", "Greenville", "SC", "GE Vernova — gas turbine mfg (AI/data-center power supply chain)", "650 total planned; ~200 hired 2025, ~300 more targeted by end 2026", "$160M (Greenville); part of $600M multi-site plan", "Estimated/Inferred mixed — production/technician roles ~$45-56k; specialist/eng. roles $91k-$226k (Glassdoor); bulk of new hires likely sub-$100k", "NEW to Watch: in-window (2026-06-27) hiring-ramp confirmation; original Jan-2025 investment announcement was pre-window", "2026-06-27", "https://scbiz.com/ge-vernova-to-invest-160m-create-650-jobs-with-greenville-expansion/", "Med"],
    [REPORT_DATE, "RTP", "Wake", "NC", "Apple — RTP campus extension (incentive-timeline extension)", "3,000 originally projected; only ~600-990 added to date", "$552M-$1B+ (paused)", "$187k avg (stated, original 2021 award)", "NEW to Watch: NC Economic Investment Committee granted a four-year extension on hiring/investment timelines (April 2026) restarting the 2021 deal (up to $845M in potential tax benefits if targets met); no active construction found", "2026-04", "https://www.carolinajournal.com/apple-delays-construction-on-552-million-rtp-campus/", "Low-Med (long-delayed, no active construction)"],
    [REPORT_DATE, "Piedmont", "Greenville", "SC", "Isuzu North America Corp. — production facility (medium-duty trucks)", "700+", "$280M", "Estimated/Inferred sub-$100k (Assembly Operator postings $52k-$72k; Quality Eng. $66k-$85k)", "$283M JBIC/MUFG construction loan disbursed 2026-06-30; direct-hire event for 150+ positions held 2026-07-08 at Greenville Tech; production starts 2027, capacity 50,000 units/yr by 2030", "2026-07-08", "https://www.automotiveworld.com/news/isuzu-secures-us283m-loan-for-south-carolina-plant/", "High"],
    [REPORT_DATE, "Fountain Inn", "Greenville", "SC", "EPC Power Corp. — power-conversion/inverter manufacturing facility", "275", "Not disclosed (site-specific)", "Estimated/Inferred sub-$100k (Mfg/Test/Eng Tech postings $47k-$66k; Production Mgr $95k-$120k)", "Facility opened 2026-07-15, ramping to full capacity within the month; serves AI data-center and grid-infrastructure customers", "2026-07-15", "https://www.foxcarolina.com/2026/07/15/epc-power-opens-facility-upstate-produce-critical-ai-data-center-technology/", "High"],
    [REPORT_DATE, "Woodruff", "Spartanburg", "SC", "BMW Group — Plant Woodruff high-voltage battery assembly", "~300 (Woodruff-specific, part of $1.7B total)", "$700M (Woodruff portion of $1.7B)", "Estimated/Inferred sub-$100k (~$43,169 avg per ZipRecruiter)", "Completion celebrated 2026-07-01/07-02 ('Home of X' event, new BMW X5 premiere); iX5 EV production starts late 2026", "2026-07-01", "https://www.press.bmwgroup.com/global/article/detail/T0458864EN/", "High"],
    [REPORT_DATE, "West Columbia", "Lexington", "SC", "Southern Glazer's Wine & Spirits — distribution facility", "500+ (stated)", "$80M", "Not disclosed; Estimated/Inferred sub-$100k (warehouse/distribution roles typically $35k-$55k)", "412,500 sq ft facility on 85 acres opened 2026-02-10/02-11 (originally planned fall 2026, opened early)", "2026-02-11", "https://www.postandcourier.com/columbia/business/wine-liquor-distributor-facility-west-columbia/article_60829410-b73e-47b4-9f46-f9c2dc79317c.html", "High"],
]
...
# ---- Week 4 (2026-07-20) ----
WEEK4_EXCLUDED = [
    [REPORT_DATE, "Snider Fleet Solutions", "Indian Land", "SC", "167", "2023", "Confirmed stale after 3 cycles tracked on Watch — all coverage traces to 2023 relocation, completed/operational by June 2023; no 2026 developments found — removed from Watch tier", "https://www.qcnews.com/news/u-s/lancaster-county/major-manufacturing-company-moving-to-indian-land/"],
    [REPORT_DATE, "FN America", "Liberty (Pickens)", "SC", "~176", "2026", "Third consecutive quiet cycle with zero forward movement — removed from Watch tier per the report's 2-cycle flag", "https://www.sccommerce.com/news/fn-america-llc-expanding-south-carolina-footprint-pickens-county-second-production-facility"],
    [REPORT_DATE, "Reynolds American — Tobaccoville Operations Center", "Tobaccoville (Forsyth)", "NC", "200", "2025-12-09", "Site-specific 200-job figure is pre-window (Dec 2025); a March 2026 $3.2B multi-site reinvestment announcement is in-window but not broken out by site; wage (~$47k-$55k) well under $100k regardless", "https://www.wfmynews2.com/article/news/local/reynolds-announces-200-new-jobs-coming-tobaccoville-operations-center/83-230e6897-51d9-4eeb-83e2-f486f0a759c3"],
    [REPORT_DATE, "AdvanceTEC", "Clayton/Smithfield (Johnston)", "NC", "160", "2026-07-07", "160 jobs below the 200-job Watch floor; wage ~$90,000 also below the $100k bar despite the in-window groundbreaking", "https://hoodline.com/2026/07/french-cleanroom-giant-drops-160-high-paying-jobs-into-johnston-county/"],
    [REPORT_DATE, "FUJIFILM Diosynth Biotechnologies expansion", "Holly Springs (Wake)", "NC", "680", "2024-04-11", "Recycled old news — original announcement dated 2024-04-11, well outside the 6-month window; no in-window update found", "https://governor.nc.gov/news/press-releases/2024/04/11/fujifilm-diosynth-biotechnologies-expands-holly-springs-facility-create-one-largest-end-end-cell"],
    [REPORT_DATE, "Cielo Digital Infrastructure \"Project Kingfisher\"", "Gaffney (Cherokee)", "SC", "30", "2026-06-23", "$2.1B capex but only 30 confirmed jobs — far below the 200-job Watch floor despite being described as the largest-ever Cherokee County investment", "https://scdailygazette.com/briefs/cherokee-county-inks-2-1b-deal-with-data-center-developer/"],
    [REPORT_DATE, "Multiple recycled Lowcountry items (Volvo Ridgeville XC60/hybrid expansion, Mercedes-Benz Ladson CKD expansion, Roper St. Francis $1.2B hospital campus)", "Berkeley/Dorchester/Charleston", "SC", "n/d", "various (2025)", "All trace to pre-window announcements (Sept 2025, Dec 2025, and June 2025 respectively) with no in-window milestone found despite active search this cycle", "n/a"],
    [REPORT_DATE, "ProKidney — Greensboro manufacturing plant (WITHDRAWN)", "Greensboro (Guilford)", "NC", "330 (orig., never tracked)", "2026-06", "Company ended its pursuit of the Greensboro plant and sold the site (June 2026) — closure/withdrawal noted for completeness only; never previously tracked since it never met the qualifying bar", "https://journalnow.com/news/local/business/health-care/prokidney-greensboro-manufacturing-plant/article_e77df70a-d8c9-11ef-82c8-a347d4b0b442.html"],
    [REPORT_DATE, "\"Barclays 1,500 jobs, North Hills\" (unverified)", "Raleigh (Wake)", "NC", "1,500 (claimed)", "unverified", "Re-checked again this cycle across Barclays newsroom, NC Governor, Wake County, EDPNC, and NC Commerce — still no authoritative primary source, only recirculating non-authoritative blog/social posts", "n/a"],
    [REPORT_DATE, "Frontier Scientific Solutions", "Wilmington (New Hanover)", "NC", "~80 (current)", "2026-03-18", "Current headcount (~80) is well below even the 200-job Watch floor; CEO's 'likely exceed 500' figure is a speculative, undated future-phase projection, not a confirmed commitment — noted for context only", "https://www.wilmingtonbiz.com/more_news/2026/03/18/amazon_facility_regional_projects_forecast_to_bring_hundreds_of_jobs_to_wilmington_area/27315"],
]
...
SOURCES = [
    ...
    ["Fort Mill Sun (Rock Hill school board)", "journal", "https://www.fortmillsun.com/2026/07/13/", "Charlotte-metro SC (York Co.)", "Octapharma — Rock Hill School Board 5-2 endorsement"],
    ["ABC11 / AOL / Yahoo News mirrors", "journal", "https://abc11.com/", "NC Triangle", "AbbVie — Durham County incentive hearing"],
    ["Carolina Journal (state budget)", "journal", "https://www.carolinajournal.com/", "NC statewide", "JetZero — FY2026-27 budget signing, $133.9M JDIG funding release"],
    ["WLTX (Columbia)", "journal", "https://www.wltx.com/", "SC Midlands", "Scout Motors — mid-July headcount reconfirmation"],
    ["NC Governor's Office (Rowan)", "state_primary", "https://governor.nc.gov/news/press-releases/2026/07/17/", "NC statewide", "American Eagle Outfitters — Rowan Co. distribution hub (Project Rack identity)"],
    ["WRHI (York County moratorium)", "regional_edo/journal", "https://www.wrhi.com/", "York Co. SC", "York County data-center moratorium final passage"],
    ["Fox Carolina (Spartanburg litigation)", "journal", "https://www.foxcarolina.com/", "Upstate SC", "NorthMark Project Moc-1 lawsuit; EPC Power opening"],
    ["Automotive World", "trade_journal", "https://www.automotiveworld.com/", "National automotive", "Isuzu North America — Piedmont SC loan/hiring event"],
    ["BMW Group press office", "company_primary", "https://www.press.bmwgroup.com/", "Company", "BMW Plant Woodruff completion event"],
    ["Post and Courier — Columbia bureau (Southern Glazer's)", "journal", "https://www.postandcourier.com/columbia/", "SC Midlands", "Southern Glazer's Wine & Spirits West Columbia opening"],
    ["Leeham News (Farnborough coverage)", "trade_journal", "https://leehamnews.com/", "National aerospace", "Boeing 787 rate confirmation at Farnborough Airshow"],
    ["WFMY News 2 (Reynolds American)", "journal", "https://www.wfmynews2.com/", "NC Triad", "Reynolds American Tobaccoville jobs (excluded)"],
    ["Hoodline (AdvanceTEC, RTP 3.0)", "journal", "https://hoodline.com/", "NC Triangle/Triad", "AdvanceTEC Johnston Co. groundbreaking; RTP 3.0 framework approval"],
    ["journalnow.com (Winston-Salem Journal)", "journal", "https://journalnow.com/", "NC Triad", "ProKidney Greensboro plant withdrawal"],
    ["SC Daily Gazette (Cielo Digital Infrastructure)", "journal", "https://scdailygazette.com/", "Upstate SC", "Cielo Digital Infrastructure Cherokee Co. data center"],
]
...
WEEK4_SCORE_DETAIL = [
    [REPORT_DATE, "SMBC Group (Charlotte)", 93, "Unchanged; no new milestone this cycle (second consecutive quiet cycle)."],
    [REPORT_DATE, "Octapharma (Rock Hill)", 88, "Rock Hill School Board's 5-2 endorsement of the amended tax-share terms is genuine forward momentum without a new negative signal; Rock Hill City Council's outstanding vote remains the key risk — net +1."],
    [REPORT_DATE, "Scout Motors (Blythewood)", 86, "Headcount and active-hiring trend reconfirmed unchanged; a previously-cited 2026-07-29 hiring-event date could not be corroborated as genuinely 2026-dated and is now treated as unverified — no score impact since the broader hiring signal stands."],
    [REPORT_DATE, "AbbVie (Durham)", 84, "Unchanged; county incentive hearing is a procedural step, not a scale change."],
    [REPORT_DATE, "Capital Group (Charlotte)", 81, "Unchanged; no new milestone this cycle."],
    [REPORT_DATE, "Genentech (Holly Springs)", 80, "Unchanged; sole dated milestone now sits exactly at the trailing-6-month window boundary — flagged for likely drop-out next cycle absent a new update."],
    [REPORT_DATE, "JetZero (Greensboro)", 80, "State budget signed 2026-07-07 releases the previously-frozen $133.9M JDIG-linked funding (execution-certainty positive); hiring-ramp timeline itself unchanged — net +1."],
    [REPORT_DATE, "Novartis (Durham/Morrisville)", 77, "Unchanged; no new milestone this cycle."],
]
...
SUMMARY_LINES = [
    ...
    ("Top mover", "Rock Hill / York Co. (SC) — Octapharma 'Project Palmetto Rock', score 88 (+1) — Rock Hill School Board voted 5-2 to back the amended tax-share terms; Rock Hill City Council's own vote remains outstanding"),
    ("Key takeaway", "Second consecutive cycle with zero brand-new qualifying (500+ job / $100k+ wage) deals across all five sub-regions — all 8 ranked entries carry forward. JetZero gained an execution-certainty boost when Gov. Stein signed the FY2026-27 state budget (2026-07-07), releasing the previously-frozen $133.9M JDIG-linked funding. A data-quality correction: last week's Scout Motors '2026-07-29 hiring event' could not be corroborated as genuinely 2026-dated (it traces to matching 2025 wage/role details) and is now flagged unverified rather than carried forward as confirmed. Genentech's sole dated milestone (2026-01-20) now sits exactly at the trailing-6-month window boundary — watch for it to age out next cycle absent a new update. SC Ports' Leatherman Terminal pause remains on track for Aug. 1 with no reversal found."),
    ("Window note", "Trailing 6 months now runs 2026-01-20 to 2026-07-20."),
    ("Data-quality note", "Scout Motors' previously-reported 2026-07-29 pre-hire event could not be independently corroborated this cycle as a genuinely 2026-dated announcement — the wage/role details match 2025-07-10 and 2025-07-25 stories precisely. Treated as unverified/likely a dating error rather than confirmed. Two Watch-tier items (Snider Fleet Solutions, FN America) were dropped this cycle after 2-3 consecutive quiet cycles with zero forward movement; four new Watch-tier items were added (Isuzu North America, EPC Power Corp., BMW Plant Woodruff, Southern Glazer's Wine & Spirits) — all clear the 500-job bar in Isuzu's/Southern Glazer's case but fail the $100k wage bar."),
    ("Week-over-week", "8 of 8 prior-ranked deals remain qualifying (none removed, none newly added); 1 gaining momentum (Octapharma, +1), 1 updated (AbbVie — county incentive hearing), 1 updated (JetZero, +1 — state budget funding release), 5 repeated (SMBC, Scout Motors, Capital Group, Genentech, Novartis)."),
]
